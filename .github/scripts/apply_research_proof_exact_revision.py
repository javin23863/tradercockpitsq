...
replace_once(
    Path("product/tradercockpit/research_configurations.py"),
...
replace_once(
    Path("product/tradercockpit/research_native_jobs.py"),
...
replace_once(
    Path("product/tradercockpit/research_candidates.py"),
