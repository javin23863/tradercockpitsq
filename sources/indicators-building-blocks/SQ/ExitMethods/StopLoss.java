...
public class StopLoss extends ExitMethod {
   ...
   private void setOrderSLValue(ILiveOrder var1, StrategyBase var2) throws TradingException {
      int var3 = var1.isLong() ? 1 : -1;
      double var4 = var1.isNettingMode() ? var1.getLastOpenPrice() : var1.getOpenPrice();
      double var6 = this.StopLoss.evaluateFormula(var2, var1.getSymbol(), var4, -var3);
      if (var6 != -9.9999999E7) {
         var6 = SQUtils.fixPrice(var2.getInstrumentInfo().tickStep, var6);
         if (var6 == var4) {
            var1.Close((byte)8);
         } else {
            var6 = this.correctSLPT(var1, var6, true);
            var1.setSL(var6).Send();
   ...
   private void setInitialOrderSLValue(ILiveOrder var1, StrategyBase var2) throws TradingException {
      int var3 = var1.isLong() ? 1 : -1;
      double var4 = var1.isNettingMode() ? var1.getLastOpenPrice() : var1.getOpenPrice();
      double var6 = this.StopLoss.evaluateFormula(var2, var1.getSymbol(), var4, -var3);
      if (var6 != -9.9999999E7) {
   ...
   public double computeValue(byte var1, StrategyBase var2, String var3, double var4) throws TradingException {
      ...
      double var7 = this.StopLoss.evaluateFormula(var2, var3, var4, -var6);
      if (var7 == -9.9999999E7) {
         return -9.9999999E7;
      }

      var7 = SQUtils.fixPrice(var2.getInstrumentInfo().tickStep, var7);
      double var9 = var2.getInstrumentInfo().tickSize;
      return this.correctSLPT(var4, var7, var6, var9, true);
   }

   public boolean setExit(ILiveOrder var1, StrategyBase var2) throws TradingException {
      int var3 = var1.isLong() ? 1 : -1;
      if (var1.getOpenPrice() == 0.0) {
         return false;
      }

      double var4 = this.StopLoss.evaluateFormula(var2, var1.getSymbol(), var1.getOpenPrice(), -var3);
      if (var4 == -9.9999999E7) {
         return false;
      }
      ...
      if (this.debugTrailingStops) {
         Log.info(SQTime.toDateMinuteString(this.Strategy.Time(0)) + " - Setting SL to: {}, corrected: {}", var4, this.correctSLPT(var1, var4, true));
      }

      var4 = this.correctSLPT(var1, var4, true);
      var1.setSL(var4).Send();
      if (!this.shouldApplySLPTToOrder(var1, var2)) {
         return true;
      }

      int var6 = var3 < 0 ? 100 : 102;
      ILiveOrder var7 = this.Strategy.Trader.Open((byte)var6, var1.getSymbol(), var4).setComment("ExitSL").setMagicNumber(var1.getMagicNumber()).Send();
      return true;
   }

   public boolean setInitialExit(ILiveOrder var1, StrategyBase var2) throws TradingException {
      int var3 = var1.isLong() ? 1 : -1;
      double var4 = this.StopLoss.evaluateFormula(var2, var1.getSymbol(), 0.0, 1);
