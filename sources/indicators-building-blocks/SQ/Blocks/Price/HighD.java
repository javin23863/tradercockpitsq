...
@BuildingBlock(name = "(DH) Daily High", returnType = 2, display = "HighD[@Chart@#Shift#]")
@SortOrder(600)
@OppositeBlock("LowD")
public class HighD extends ValueBlock {
   @Parameter
   ...
   public double OnBlockEvaluate(int var1) throws TradingException {
      if (this.Strategy.isStockpicker()) {
         return this.Strategy.Stockpicker.strategyTriggeredAt() == 5 && var1 + this.Shift == 0
            ? this.Strategy.Stockpicker.data.OpenD(this.chartIndex, var1 + this.Shift)
            : this.Strategy.Stockpicker.data.HighD(this.chartIndex, var1 + this.Shift);
      }

      if (!this.Strategy.isTradestationEngine()) {
         return this.Chart.HighD(this.Shift + var1);
      }
      ...
      if (this.Shift == 0 && var2 == 0 && var1 != 0) {
         ...
         return this.Chart.HighD(this.Shift + var2);
      }
   }
   ...
   private double calculateHighDUpToBar(int var1, int var2) throws TradingException {
      ...
      for (int var5 = var1; var5 <= var2 && SQTime.isSameDay(this.Chart.Time.get(var5), this.Chart.Time.get(var1)); var5++) {
