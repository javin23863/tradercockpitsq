...
@BuildingBlock(name = "(SL) Session Low", returnType = 2, display = "SessionLow(@Chart@#StartHours#:#StartMinutes#-#EndHours#:#EndMinutes#)[#Shift#]")
...
public class SessionLow extends ValueBlock {
   ...
   protected void OnInit() throws BlockDefinitionException {
      this.sessionCalculator = new SessionOHLCCalculator((byte)3, this.StartHours, this.StartMinutes, this.EndHours, this.EndMinutes, this.Shift, this.Chart);
   }
