...
@BuildingBlock(name = "(WH) Weekly High", returnType = 2, display = "HighW[@Chart@#Shift#]")
@SortOrder(600)
@OppositeBlock("LowW")
public class HighW extends ValueBlock {
   ...
   public double OnBlockEvaluate(int var1) throws TradingException {
      if (this.Strategy.isStockpicker()) {
         return this.Strategy.Stockpicker.strategyTriggeredAt() == 5 && var1 + this.Shift == 0
            ...
            : this.Strategy.Stockpicker.data.HighW(this.chartIndex, var1 + this.Shift);
      }

      if (!Engines.isTradestationEngine(this.Strategy.getEngine())) {
         return this.Chart.HighW(this.Shift + var1);
      }
      ...
      if (this.Shift == 0 && var2 == 0 && var1 != 0) {
         ...
         return this.Chart.HighW(this.Shift + var2);
      }
   }
   ...
   private double calculateHighDUpToBar(int var1, int var2) throws TradingException {
      ...
      for (int var5 = var1; var5 <= var2 && SQTime.isSameWeek(this.Chart.Time.get(var5), this.Chart.Time.get(var1)) == 2; var5++) {
