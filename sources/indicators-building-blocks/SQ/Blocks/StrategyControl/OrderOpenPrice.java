...
@BuildingBlock(name = "Order Open Price", display = "OrderOpenPrice(#Symbol#, #MagicNumber#, #Direction#, \"#Comment#\")", returnType = 1)
@Help("Returns open price level for specified order")
@SortOrder(1000)
@IgnoreInBuilder
public class OrderOpenPrice extends ValueBlock {
