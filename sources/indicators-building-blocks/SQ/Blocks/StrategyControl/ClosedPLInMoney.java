...
@BuildingBlock(name = "Closed P/L (in money)", display = "Closed P/L in money(#Symbol#, #MagicNumber#, #Direction#, \"#Comment#\")", returnType = 1)
@Help(
   "Returns last closed P/L in money for order with given Magic Number. It will return 0 if the order hasn't closed yet. If Magic Number is 0, it will return closed P/L of last order."
)
@SortOrder(900)
@IgnoreInBuilder
public class ClosedPLInMoney extends ValueBlock {
      ...
      for (int var3 = this.Strategy.Trader.getHistoryOrdersCount() - 1; var3 >= 0; var3--) {
         ...
         if (var4.isRealOrder() && OrderFunctions.identify(var4, this.Strategy, this.Symbol, this.Direction, this.MagicNumber, this.Comment)) {
            if (var2 == this.TradesAgo) {
               return var4.isFilledOrder() ? this.getPL(var4) : 0.0;
            }
   ...
   private double getPL(Order var1) {
      ...
      return SQUtils.round(var2 * var1.Size * this.Strategy.getInstrumentInfo().pointValue, 2) + var1.CommSwap;
   }
}
