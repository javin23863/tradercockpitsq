...
@Help("Close specified pending order")
@SortOrder(100)
@CategoryOrder(300)
@IgnoreInBuilder
@ForEngine("*,-MC,-TS,-SP,-SA")
public class ClosePendingOrder extends ActionBlock {
   ...
   public void OnAction() throws TradingException {
      for (int var1 = 0; var1 < this.Strategy.Trader.getOpenOrdersCount(false); var1++) {
         ...
         if (var2.isPendingOrder() && OrderFunctions.identify(var2, this.Strategy, this.Symbol, this.Direction, this.MagicNumber, this.Comment)) {
            var2.Close((byte)22);
            return;
         }
      }
