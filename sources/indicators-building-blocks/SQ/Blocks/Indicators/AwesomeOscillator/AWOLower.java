...
@BuildingBlock(name = "Awesome Oscillator is lower than Level", display = "AwesomeOscillator(@Chart@)[#Shift#] < #Level#", returnType = 3)
@OppositeBlock(value = "AWOHigher", oscillator = true, middleValue = 0.0, field = "Level")
