...
@BuildingBlock(
   name = "(KC) Bar closes above Upper band",
   display = "Bar closes above Keltner Channel(@Chart@#Period#, #Deviation#).Upper[#Shift#]",
   returnType = 3
)
...
public class KCBarClosesAboveUpper extends ConditionBlock {
   ...
   public boolean OnBlockEvaluate() throws TradingException {
      double var1 = this.Strategy.Indicators.KeltnerChannel(this.Input, this.Period, this.Deviation).Upper.getRounded(this.Shift);
