...
@BuildingBlock(
   name = "(KC) Bar opens above Lower band",
   display = "Bar opens above Keltner Channel(@Chart@#Period#, #Deviation#).Lower[#Shift#]",
   returnType = 3
)
@Help("Is triggered if Bar opens above KC Lower band")
@OppositeBlock("KCBarOpensBelowUpper")
@ParameterSets(
   {
...
public class KCBarOpensAboveLower extends ConditionBlock {
   @Parameter
