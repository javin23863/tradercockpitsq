...
@BuildingBlock(
   name = "(KC) Bar opens below Upper band after opened above",
   display = "Bar opens below Keltner Channel(@Chart@#Period#, #Deviation#).Upper[#Shift#] after opened above",
   returnType = 3
)
@Help("Is triggered if Bar opens below KC Upper band after opened above")
@OppositeBlock("KCBarOpensAboveLowerAfterOpenBelow")
@ParameterSets(
   {
...
public class KCBarOpensBelowUpperAfterOpenAbove extends ConditionBlock {
   @Parameter
