...
@BuildingBlock(
   name = "(KC) Bar opens above Upper band after opened below",
   display = "Bar opens above Keltner Channel(@Chart@#Period#, #Deviation#).Upper[#Shift#] after opened below",
   returnType = 3
)
@Help("Is triggered if Bar opens above KC Upper band after opened below")
@OppositeBlock("KCBarOpensBelowLowerAfterOpenAbove")
@ParameterSets(
   {
...
public class KCBarOpensAboveUpperAfterOpenBelow extends ConditionBlock {
   @Parameter
