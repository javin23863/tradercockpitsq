...
@BuildingBlock(
   name = "(KC) Bar opens below Lower band",
   display = "Bar opens below Keltner Channel(@Chart@#Period#, #Deviation#).Lower[#Shift#]",
   returnType = 3
)
@Help("Is triggered if Bar opens below KC Lower band")
@OppositeBlock("KCBarOpensAboveUpper")
@ParameterSets(
   {
...
public class KCBarOpensBelowLower extends ConditionBlock {
   @Parameter
