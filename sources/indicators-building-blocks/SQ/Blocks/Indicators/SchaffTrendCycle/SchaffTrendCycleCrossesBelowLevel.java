...
@BuildingBlock(
   name = "(STCCBL) Schaff TrendCycle crosses below Level",
   display = "Schaff Trend Cycle(@Chart@#StochPeriod#,#FastPeriod#,#SlowPeriod#)[#Shift#] crosses below #Level#",
   returnType = 3
)
@Help("Is triggered if Schaff Trend Cycle crosses above Level")
@OppositeBlock(value = "SchaffTrendCycleCrossesAboveLevel", oscillator = true, middleValue = 50.0, field = "Level")
@ParameterSets(
   {
