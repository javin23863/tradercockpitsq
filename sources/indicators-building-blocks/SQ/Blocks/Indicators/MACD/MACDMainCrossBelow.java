...
@BuildingBlock(
   name = "MACD Main line crosses below Level",
   display = "MACD(@Chart@#Fast#, #Slow#, #Smooth#).Main[#Shift#] crosses below #Level#",
   returnType = 3
)
@SortOrder(400)
@OppositeBlock(value = "MACDMainCrossAbove", oscillator = true, middleValue = 0.0, field = "Level")
@ParameterSets(
   {
