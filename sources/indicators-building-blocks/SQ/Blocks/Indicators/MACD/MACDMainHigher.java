...
@BuildingBlock(name = "MACD Main line is higher than Level", display = "MACD(@Chart@#Fast#, #Slow#, #Smooth#).Main[#Shift#] > #Level#", returnType = 3)
@SortOrder(1100)
@OppositeBlock(value = "MACDMainLower", oscillator = true, middleValue = 0.0, field = "Level")
@ParameterSets(
   {
