...
@BuildingBlock(name = "MACD Main line is lower than Level", display = "MACD(@Chart@#Fast#, #Slow#, #Smooth#).Main[#Shift#] < #Level#", returnType = 3)
@SortOrder(1200)
@OppositeBlock(value = "MACDMainHigher", oscillator = true, middleValue = 0.0, field = "Level")
@ParameterSets(
   {
