...
@BuildingBlock(name = "StdDev is higher than Level", display = "StdDev(@Chart@#Period#)[#Shift#] > #Level#", returnType = 3)
...
public class StdDevHigher extends ConditionBlock {
   ...
   public int Period;
   @Parameter(defaultValue = "0.01", minValue = 1.0E-4, maxValue = 3.0, step = 0.01, builderMinValue = 1.0E-4, builderMaxValue = 1.0, builderStep = 2.5E-4)
   public double Level;
   @Parameter
   public int Shift;
