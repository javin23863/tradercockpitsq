...
@BuildingBlock(
   name = "(FASK) Fast KAMA is above Slow KAMA",
   display = "Fast KAMA(@Chart@#FastERPeriod#,#FastShortPeriod#,#FastLongPeriod#)[#Shift#] is above Slow KAMA(@Chart@#SlowERPeriod#,#SlowShortPeriod#,#SlowLongPeriod#)",
   returnType = 3
)
