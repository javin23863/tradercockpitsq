...
@BuildingBlock(name = "ATR crosses below Level", display = "ATR(@Chart@#Period#)[#Shift#] crosses below #Level#", returnType = 3)
...
public class ATRCrossDown extends ConditionBlock {
   ...
   public int Period;
   @Parameter(defaultValue = "0", minValue = -5000.0, maxValue = 5000.0, step = 0.001, builderMinValue = 0.0, builderMaxValue = 3.0, builderStep = 0.001)
   public double Level;
   @Parameter
   public int Shift;
