...
@BuildingBlock(name = "(VP21) Rising POC (Long Regime)", display = "RisingPOC(@Chart@#LookbackBars#,#MinimumShift#)", returnType = 3)
@Help(
   "POC migration upward: current session POC is higher than the POC from LookbackBars ago by at least MinimumShift pips. Rising fair value across sessions suggests a bullish regime—prefer long setups on pullbacks to prior POC/value levels."
)
