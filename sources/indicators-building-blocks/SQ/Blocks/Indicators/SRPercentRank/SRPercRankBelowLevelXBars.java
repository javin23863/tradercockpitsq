...
@BuildingBlock(
   name = "(PRBLX) SR Percent Rank is below Level for X Bars",
   display = " SR Percent Rank(@Chart@#Mode#,#Length#,#ATRPeriod#)[#Shift#] is below #Level# for #Bars# Bars",
   returnType = 3
)
@Help("Is triggered if SRPercentRank is below Level for X Bars")
@OppositeBlock("SRPercRankBelowLevelXBars")
@ParameterSets(
   {
