...
@BuildingBlock(name = "Bulls Power crosses above Level", display = "BullsPower(@Chart@#Period#)[#Shift#] crosses above #Level#", returnType = 3)
@OppositeBlock(value = "BEPCrossDown", oscillator = true, middleValue = 0.0, field = "Level")
@SortOrder(500)
@ParameterSets(
   {
