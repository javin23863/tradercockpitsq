...
@BuildingBlock(name = "Bulls Power crosses below Level", display = "BullsPower(@Chart@#Period#)[#Shift#] crosses below #Level#", returnType = 3)
@OppositeBlock(value = "BEPCrossUp", oscillator = true, middleValue = 0.0, field = "Level")
@SortOrder(600)
@ParameterSets(
   {
