...
@BuildingBlock(name = "Bulls Power is lower than Level", display = "BullsPower(@Chart@#Period#)[#Shift#] < #Level#", returnType = 3)
@OppositeBlock(value = "BEPHigher", oscillator = true, middleValue = 0.0, field = "Level")
@SortOrder(400)
@ParameterSets(
   {
