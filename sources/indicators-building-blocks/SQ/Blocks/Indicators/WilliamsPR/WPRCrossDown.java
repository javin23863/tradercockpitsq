...
@BuildingBlock(name = "Williams%R crosses below Level", display = "Williams%R(@Chart@#Period#)[#Shift#] crosses below #Level#", returnType = 3)
@OppositeBlock(value = "WPRCrossUp", oscillator = true, middleValue = -50.0, field = "Level")
@SortOrder(600)
@ParameterSets(
   {
