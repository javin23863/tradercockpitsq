...
@BuildingBlock(name = "Williams%R is lower than Level", display = "Williams%R(@Chart@#Period#)[#Shift#] < #Level#", returnType = 3)
@OppositeBlock(value = "WPRHigher", oscillator = true, middleValue = -50.0, field = "Level")
@SortOrder(400)
@ParameterSets(
   {
