...
@BuildingBlock(name = "Williams%R crosses above Level", display = "Williams%R(@Chart@#Period#)[#Shift#] crosses above #Level#", returnType = 3)
@OppositeBlock(value = "WPRCrossDown", oscillator = true, middleValue = -50.0, field = "Level")
@SortOrder(500)
@ParameterSets(
   {
