...
@BuildingBlock(
   name = "(DVWAPU) Faster Anchored VWAP is above Slower Anchored VWAP",
   display = "Faster AnchoredVWAP(@Chart@#FastSessionType#,#FastStdDevMult#)[#Shift#] is above Slower AnchoredVWAP(@Chart@#SlowSessionType#,#SlowStdDevMult#)[#Shift#]",
   returnType = 3
)
