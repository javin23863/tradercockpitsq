...
@BuildingBlock(name = "(ROCCBL) ROC crosses below Level", display = "ROC(@Chart@#Period#)[#Shift#] crosses below #Level#", returnType = 3)
@Help("Is triggered if ROC is below Level")
@OppositeBlock(value = "ROCCrossesAboveLevel", oscillator = true, middleValue = 0.0, field = "Level")
@ParameterSets(
   {
