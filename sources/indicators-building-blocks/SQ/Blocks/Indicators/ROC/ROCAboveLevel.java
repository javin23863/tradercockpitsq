...
@BuildingBlock(name = "(ROCAL) ROC is above Level", display = "ROC(@Chart@#Period#)[#Shift#] is above #Level#", returnType = 3)
@Help("Is triggered if ROC is above Level")
@OppositeBlock(value = "ROCBelowLevel", oscillator = true, middleValue = 0.0, field = "Level")
@ParameterSets(
   {
