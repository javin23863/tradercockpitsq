...
@BuildingBlock(name = "RSI is rising", display = "RSI(@Chart@#Period#)[#Shift#] is rising", returnType = 3)
@Help("Is triggered if RSI is rising")
@SortOrder(100)
@CategoryOrder(700)
@OppositeBlock("RSIFalling")
@ParameterSets(
   {
...
public class RSIRising extends ConditionBlock {
   @Parameter
