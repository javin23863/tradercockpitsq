...
@BuildingBlock(name = "RSI is higher than Level", display = "RSI(@Chart@#Period#)[#Shift#] > #Level#", returnType = 3)
@SortOrder(300)
@OppositeBlock(value = "RSILower", oscillator = true, middleValue = 50.0, field = "Level")
@ParameterSets(
   {
