...
@BuildingBlock(name = "RSI changes direction downwards", display = "RSI(@Chart@#Period#)[#Shift#] changes direction downwards", returnType = 3)
@Help("Is triggered if RSI changes direction downwards")
@SortOrder(100)
@OppositeBlock("RSIChangesUp")
@ParameterSets(
   {
...
public class RSIChangesDown extends ConditionBlock {
   @Parameter
   ...
   public boolean OnBlockEvaluate() throws TradingException {
      RSI var1 = this.Strategy.Indicators.RSI(this.Input, this.Period);
