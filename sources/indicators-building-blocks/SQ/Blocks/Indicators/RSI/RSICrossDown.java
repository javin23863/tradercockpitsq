...
@BuildingBlock(name = "RSI crosses below Level", display = "RSI(@Chart@#Period#)[#Shift#] crosses below #Level#", returnType = 3)
@SortOrder(600)
@OppositeBlock(value = "RSICrossUp", oscillator = true, middleValue = 50.0, field = "Level")
@ParameterSets(
   {
