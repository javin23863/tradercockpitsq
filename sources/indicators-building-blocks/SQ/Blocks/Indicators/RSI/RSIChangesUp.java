...
@BuildingBlock(name = "RSI changes direction upwards", display = "RSI(@Chart@#Period#)[#Shift#] changes direction upwards", returnType = 3)
@Help("Is triggered if RSI changes direction upwards")
@SortOrder(700)
@OppositeBlock("RSIChangesDown")
@ParameterSets(
   {
...
public class RSIChangesUp extends ConditionBlock {
   @Parameter
