...
@BuildingBlock(name = "RSI is lower than Level", display = "RSI(@Chart@#Period#)[#Shift#] < #Level#", returnType = 3)
@SortOrder(400)
@OppositeBlock(value = "RSIHigher", oscillator = true, middleValue = 50.0, field = "Level")
@ParameterSets(
   {
