...
@BuildingBlock(name = "RSI crosses above Level", display = "RSI(@Chart@#Period#)[#Shift#] crosses above #Level#", returnType = 3)
@SortOrder(500)
@OppositeBlock(value = "RSICrossDown", oscillator = true, middleValue = 50.0, field = "Level")
@ParameterSets(
   {
