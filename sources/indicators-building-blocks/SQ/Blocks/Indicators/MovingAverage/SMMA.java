...
@BuildingBlock(name = "(SMMA) Smoothed Moving Average", display = "SMMA(@Chart@#Period#)[#Shift#]", returnType = 2)
...
public class SMMA extends IndicatorBlock {
   ...
   public int Period;
   @Output(name = "SMMA", color = "#FF0000")
   public DataSeries Value;
   private AverageCalculator averageCalculator;

   protected void OnInit() throws TradingException {
      this.averageCalculator = new AverageCalculator(2, this.Period);
   }
