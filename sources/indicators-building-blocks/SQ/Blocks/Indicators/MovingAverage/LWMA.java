...
@BuildingBlock(name = "(LWMA) Linear Weighted Moving Average", display = "LWMA(@Chart@#Period#)[#Shift#]", returnType = 2)
...
public class LWMA extends IndicatorBlock {
   ...
   public int Period;
   @Output(name = "LWMA", color = "#FF0000")
   public DataSeries Value;
   private AverageCalculator averageCalculator;

   protected void OnInit() throws TradingException {
      this.averageCalculator = new AverageCalculator(3, this.Period);
   }
