...
@BuildingBlock(name = "ADX is higher than Level", display = "ADX(@Chart@#Period#)[#Shift#] > #Level#", returnType = 3)
@OppositeBlock(value = "ADXHigher", middleValue = 50.0, field = "Level")
@SortOrder(300)
@ParameterSets(
   {
