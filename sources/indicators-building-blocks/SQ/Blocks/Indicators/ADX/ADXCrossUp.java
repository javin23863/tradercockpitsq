...
@BuildingBlock(name = "ADX crosses above Level", display = "ADX(@Chart@#Period#)[#Shift#] crosses above #Level#", returnType = 3)
@OppositeBlock(value = "ADXCrossUp", middleValue = 50.0, field = "Level")
@SortOrder(500)
@ParameterSets(
   {
