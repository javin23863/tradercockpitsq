...
@BuildingBlock(name = "(WFU) Woodies Famir UP", display = "Woodies Famir UP(@Chart@#Period#,#Factor#)[#Shift#]", returnType = 3)
@Help(
   "Is triggered if CCI makes ZLR Down pattern and next bar fails. It is counter trend pattern; Factor = minimum distance between top and bottom hook on CCI chart."
)
...
public class WoodiesFamirUP extends ConditionBlock {
   ...
   public boolean OnBlockEvaluate() throws TradingException {
      ...
      boolean var17 = var4 - var2 > this.Factor && var4 - var6 > this.Factor;
