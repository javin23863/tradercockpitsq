...
@BuildingBlock(name = "(WZU) WoodiesZLRUP", display = "WoodiesZLRUP(@Chart@#Period#,#Factor#)[#Shift#]", returnType = 3)
...
public class WoodiesZLRUP extends ConditionBlock {
   ...
   public boolean OnBlockEvaluate() throws TradingException {
      ...
      boolean var15 = var12 - var2 > this.Factor && var4 - var2 > this.Factor;
