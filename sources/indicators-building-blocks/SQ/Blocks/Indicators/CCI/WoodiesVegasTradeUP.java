...
@BuildingBlock(name = "(WVU) Woodies Vegas Trade UP", display = "Woodies Vegas Trade UP(@Chart@#Period#,#Factor#)[#Shift#]", returnType = 3)
@Help(
   "Is triggered if CCI rise up from -200 leves and make U. It is counter trend pattern, Factor = minimum distance between top and bottom hook on CCI chart"
)
...
public class WoodiesVegasTradeUP extends ConditionBlock {
   ...
   public boolean OnBlockEvaluate() throws TradingException {
      ...
      boolean var16 = var4 - var2 > this.Factor && var6 - var8 > this.Factor;
