...
@BuildingBlock(name = "CCI is higher than Level", display = "CCI(@Chart@#Period#)[#Shift#] > #Level#", returnType = 3)
@SortOrder(300)
@OppositeBlock(value = "CCILower", oscillator = true, middleValue = 0.0, field = "Level")
@ParameterSets(
   {
