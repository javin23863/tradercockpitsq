...
@BuildingBlock(name = "CCI crosses above Level", display = "CCI(@Chart@#Period#)[#Shift#] crosses above #Level#", returnType = 3)
@SortOrder(500)
@OppositeBlock(value = "CCICrossDown", oscillator = true, middleValue = 0.0, field = "Level")
@ParameterSets(
   {
