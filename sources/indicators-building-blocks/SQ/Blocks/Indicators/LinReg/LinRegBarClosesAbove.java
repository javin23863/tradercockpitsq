...
@BuildingBlock(
   name = "Bar closes above LinReg",
   display = "Bar closes above LinReg(@Chart@#Period#)[#Shift#]",
   returnType = 3,
...
public class LinRegBarClosesAbove extends ConditionBlock {
   ...
   public boolean OnBlockEvaluate() throws TradingException {
      double var1 = this.Strategy.Indicators.LinearRegression(this.Chart.getSeries(this.ComputedFrom), this.Period).Value.getRounded(this.Shift);
