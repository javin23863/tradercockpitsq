...
@BuildingBlock(name = "Momentum is higher than Level", display = "Momentum(@Chart@#Period#)[#Shift#] > #Level#", returnType = 3)
@SortOrder(300)
@OppositeBlock(value = "MomLower", oscillator = true, middleValue = 100.0, field = "Level")
@ParameterSets(
   {
