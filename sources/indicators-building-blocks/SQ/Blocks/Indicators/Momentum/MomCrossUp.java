...
@BuildingBlock(name = "Momentum crosses above Level", display = "Momentum(@Chart@#Period#)[#Shift#] crosses above #Level#", returnType = 3)
@SortOrder(500)
@OppositeBlock(value = "MomCrossDown", oscillator = true, middleValue = 100.0, field = "Level")
@ParameterSets(
   {
