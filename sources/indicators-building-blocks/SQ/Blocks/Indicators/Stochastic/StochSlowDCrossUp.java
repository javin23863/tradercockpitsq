...
@BuildingBlock(
   name = "Stochastic.Slow %D crosses above Level",
   display = "Stoch(@Chart@#KPeriod#, #DPeriod#, #Slowing#).Slow %D[#Shift#] crosses above #Level#",
   returnType = 3
)
@SortOrder(500)
@OppositeBlock(value = "StochSlowDCrossDown", oscillator = true, middleValue = 50.0, field = "Level")
@ParameterSets(
   {
