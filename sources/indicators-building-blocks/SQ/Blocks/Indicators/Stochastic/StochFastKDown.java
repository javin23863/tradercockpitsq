...
@BuildingBlock(
   name = "Stochastic.Fast %K is lower than Slow %D",
   display = "Stoch(@Chart@#KPeriod#, #DPeriod#, #Slowing#).Fast %K[#Shift#] is lower than Stoch(@Chart@#KPeriod#, #DPeriod#, #Slowing#).Slow %D",
   returnType = 3
)
@SortOrder(100)
...
public class StochFastKDown extends ConditionBlock {
   ...
   public boolean OnBlockEvaluate() throws TradingException {
      ...
      double var2 = var1.FastK.getRounded(this.Shift);
