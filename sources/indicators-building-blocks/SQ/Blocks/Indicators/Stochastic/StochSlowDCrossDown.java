...
@BuildingBlock(
   name = "Stochastic.Slow %D crosses below Level",
   display = "Stoch(@Chart@#KPeriod#, #DPeriod#, #Slowing#).Slow %D[#Shift#] crosses below #Level#",
   returnType = 3
)
@SortOrder(600)
@OppositeBlock(value = "StochSlowDCrossUp", oscillator = true, middleValue = 50.0, field = "Level")
@ParameterSets(
   {
