...
@BuildingBlock(
   name = "Stochastic.Fast %K is higher than Slow %D",
   display = "Stoch(@Chart@#KPeriod#, #DPeriod#, #Slowing#).Fast %K[#Shift#] is higher than Stoch(#KPeriod#, #DPeriod#, #Slowing#).Slow %D",
   returnType = 3
)
@SortOrder(100)
