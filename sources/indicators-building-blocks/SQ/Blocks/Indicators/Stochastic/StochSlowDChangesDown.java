...
@BuildingBlock(
   name = "Stochastic.Slow %D changes direction downwards",
   display = "Stoch(@Chart@#KPeriod#, #DPeriod#, #Slowing#).Slow %D[#Shift#] changes direction downwards",
   returnType = 3
)
...
public class StochSlowDChangesDown extends ConditionBlock {
   ...
   public boolean OnBlockEvaluate() throws TradingException {
      ...
      double var2 = var1.SlowD.getRounded(this.Shift + 2);
      double var4 = var1.SlowD.getRounded(this.Shift + 1);
      double var6 = var1.SlowD.getRounded(this.Shift);
