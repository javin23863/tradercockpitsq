...
@BuildingBlock(
   name = "Stochastic.Slow %D is higher than Level",
   display = "Stoch(@Chart@#KPeriod#, #DPeriod#, #Slowing#).Slow %D[#Shift#] > #Level#",
   returnType = 3
)
@SortOrder(300)
@OppositeBlock(value = "StochSlowDLower", oscillator = true, middleValue = 50.0, field = "Level")
@ParameterSets(
   {
...
public class StochSlowDHigher extends ConditionBlock {
   ...
   public boolean OnBlockEvaluate() throws TradingException {
      ...
      double var2 = var1.SlowD.getRounded(this.Shift);
