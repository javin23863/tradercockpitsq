...
@BuildingBlock(
   name = "Stochastic.Fast %K crosses above Level",
   display = "Stoch(@Chart@#KPeriod#, #DPeriod#, #Slowing#).Fast %K[#Shift#] crosses above #Level#",
   returnType = 3
)
@SortOrder(500)
@OppositeBlock(value = "StochFastKCrossDown", oscillator = true, middleValue = 50.0, field = "Level")
@ParameterSets(
   {
