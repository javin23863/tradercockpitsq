...
@BuildingBlock(name = "(BB) Bar closes below Lower band", display = "Bar closes below BB(@Chart@#Period#, #Deviation#).Lower[#Shift#]", returnType = 3)
...
public class BBBarClosesBelowDown extends ConditionBlock {
   ...
   public boolean OnBlockEvaluate() throws TradingException {
      double var1 = this.Strategy.Indicators.BollingerBands(this.Chart.getSeries(this.ComputedFrom), this.Period, this.Deviation).Lower.getRounded(this.Shift);
