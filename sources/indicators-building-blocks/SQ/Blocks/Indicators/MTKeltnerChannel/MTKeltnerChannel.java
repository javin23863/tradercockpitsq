package SQ.Blocks.Indicators.MTKeltnerChannel;
...
@BuildingBlock(name = "(MTKC) MT Keltner Channel", display = "MT Keltner Channel(@Chart@#Period#, #Deviation#).#Line#[#Shift#]", returnType = 2)
@ParameterSets(
   {
...
public class MTKeltnerChannel extends IndicatorBlock {
   @Parameter
   public ChartData Input;
   @Parameter(name = "Period", defaultValue = "20", minValue = 2.0, maxValue = 10000.0, step = 1.0)
   public int Period;
   @Parameter(defaultValue = "1.5", minValue = 0.01, maxValue = 10.0, step = 0.01, builderMinValue = 0.5, builderMaxValue = 3.0, builderStep = 0.1)
   ...
   protected void OnBarUpdate() throws TradingException {
      this.middleAverageCalculator.onBarUpdate(this.Input.Close.get(0), this.getCurrentBar());
