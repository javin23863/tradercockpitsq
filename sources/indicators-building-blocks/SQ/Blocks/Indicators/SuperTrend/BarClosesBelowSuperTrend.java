...
@BuildingBlock(
   name = "(BCAST) Bar closes below SuperTrend",
   display = "Bar closes below SuperTrend(@Chart@#Mode#,#ATRPeriod#,#ATRMult#)[#Shift#]",
   returnType = 3
)
...
public class BarClosesBelowSuperTrend extends ConditionBlock {
   ...
   public boolean OnBlockEvaluate() throws TradingException {
      ...
      double var4 = this.Input.Close.get(this.Shift);
      return var4 < var2;
   }
}
