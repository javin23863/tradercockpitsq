...
@BuildingBlock(name = "(STR) Super Trend is in Range", display = "SuperTrend(@Chart@#Mode#,#ATRPeriod#,#ATRMult#)[#Shift#] is in Range", returnType = 3)
...
public class SuperTrendInRange extends ConditionBlock {
   ...
   public boolean OnBlockEvaluate() throws TradingException {
      ...
      double var2 = var1.Value.getRounded(this.Shift, 5);
      double var4 = var1.Value.getRounded(this.Shift + 1, 5);
      return var2 == var4;
   }
}
