...
@BuildingBlock(
   name = "DI- changes direction downwards",
   display = "DI-(@Chart@#Period#)[#Shift#] changes direction downwards",
   returnType = 3,
   mainIndicator = "ADX"
)
...
public class DIMinusChangesDown extends ConditionBlock {
   ...
   public boolean OnBlockEvaluate() throws TradingException {
      ...
      double var2 = var1.DIMinus.getRounded(this.Shift + 2);
      double var4 = var1.DIMinus.getRounded(this.Shift + 1);
      double var6 = var1.DIMinus.getRounded(this.Shift);
