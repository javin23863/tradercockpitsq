...
@BuildingBlock(name = "DeMarker is rising", display = "DeMarker(@Chart@#Period#)[#Shift#] is rising", returnType = 3)
@Help("Is triggered if DeMarker is rising")
@OppositeBlock("DEMFalling")
@SortOrder(100)
@CategoryOrder(1200)
@ParameterSets(
   {
...
public class DEMRising extends ConditionBlock {
   @Parameter
