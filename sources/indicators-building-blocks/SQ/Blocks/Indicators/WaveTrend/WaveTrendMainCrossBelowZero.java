...
@BuildingBlock(
   name = "WaveTrend Main line crosses below 0",
   display = "WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] crosses below 0",
   returnType = 3
)
@OppositeBlock("WaveTrendMainCrossAboveZero")
...
public class WaveTrendMainCrossBelowZero extends ConditionBlock {
