...
@BuildingBlock(name = "WaveTrend Main line is falling", display = "WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] is falling", returnType = 3)
@Help("Is triggered if WaveTrend Main is falling")
@ForEngine("MT4,MT5,TS,MC")
@OppositeBlock("WaveTrendMainRising")
@SortOrder(900)
@ParameterSets(
   {
...
public class WaveTrendMainFalling extends ConditionBlock {
