...
@BuildingBlock(
   name = "WaveTrend Main line crosses below Signal",
   display = "WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] crosses below WaveTrend.Signal",
   returnType = 3
)
...
public class WaveTrendMainCrossBelowSignal extends ConditionBlock {
   ...
   public boolean OnBlockEvaluate() throws TradingException {
      ...
      double var2 = var1.WT1.getRounded(this.Shift + 1);
      double var4 = var1.WT1.getRounded(this.Shift);
      double var6 = var1.WT2.getRounded(this.Shift + 1);
      double var8 = var1.WT2.getRounded(this.Shift);
