...
@BuildingBlock(
   name = "WaveTrend Main line crosses below Level",
   display = "WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] crosses below #Level#",
   returnType = 3
)
@OppositeBlock(value = "WaveTrendMainCrossAbove", oscillator = true, middleValue = 0.0, field = "Level")
@SortOrder(400)
