...
@BuildingBlock(name = "WaveTrend Main line is rising", display = "WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] is rising", returnType = 3)
@Help("Is triggered if WaveTrend Main is rising")
@SortOrder(1000)
@ForEngine("MT4,MT5,TS,MC")
@OppositeBlock("WaveTrendMainFalling")
@ParameterSets(
   {
...
public class WaveTrendMainRising extends ConditionBlock {
