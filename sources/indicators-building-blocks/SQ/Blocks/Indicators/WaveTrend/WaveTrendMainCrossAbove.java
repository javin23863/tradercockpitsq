...
@BuildingBlock(
   name = "WaveTrend Main line crosses above Level",
   display = "WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] crosses above #Level#",
   returnType = 3
)
@OppositeBlock(value = "WaveTrendMainCrossBelow", oscillator = true, middleValue = 0.0, field = "Level")
@SortOrder(300)
