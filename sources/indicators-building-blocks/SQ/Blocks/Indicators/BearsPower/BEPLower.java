...
@BuildingBlock(name = "Bears Power is lower than Level", display = "BearsPower(@Chart@#Period#)[#Shift#] < #Level#", returnType = 3)
@OppositeBlock(value = "BUPHigher", oscillator = true, middleValue = 0.0, field = "Level")
@SortOrder(400)
@ParameterSets(
   {
