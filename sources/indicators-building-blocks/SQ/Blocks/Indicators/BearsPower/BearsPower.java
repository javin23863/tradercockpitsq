...
@BuildingBlock(name = "(BP) Bears Power", display = "BearsPower(@Chart@#Period#, #ComputedFrom#)[#Shift#]", returnType = 1)
...
public class BearsPower extends IndicatorBlock {
   ...
   protected void OnBarUpdate() throws TradingException {
      ...
      this.Value.set(0, this.Input.Low.get(0) - this.averageCalculator.getValue());
   }
}
