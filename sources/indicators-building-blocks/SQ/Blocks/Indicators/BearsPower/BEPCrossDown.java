...
@BuildingBlock(name = "Bears Power crosses below Level", display = "BearsPower(@Chart@#Period#)[#Shift#] crosses below #Level#", returnType = 3)
@OppositeBlock(value = "BUPCrossUp", oscillator = true, middleValue = 0.0, field = "Level")
@SortOrder(600)
@ParameterSets(
   {
