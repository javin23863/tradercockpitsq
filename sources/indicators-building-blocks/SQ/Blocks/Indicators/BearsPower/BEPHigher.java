...
@BuildingBlock(name = "Bears Power is higher than Level", display = "BearsPower(@Chart@#Period#)[#Shift#] > #Level#", returnType = 3)
@OppositeBlock(value = "BUPLower", oscillator = true, middleValue = 0.0, field = "Level")
@SortOrder(300)
@ParameterSets(
   {
