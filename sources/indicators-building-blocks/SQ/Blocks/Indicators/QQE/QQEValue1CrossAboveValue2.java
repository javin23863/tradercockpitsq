...
@BuildingBlock(name = "QQE Value1 line crosses above Value2", display = "QQE(@Chart@#RSIPeriod#).Value1[#Shift#] crosses above QQE.Value2", returnType = 3)
@SortOrder(500)
...
public class QQEValue1CrossAboveValue2 extends ConditionBlock {
   ...
   public boolean OnBlockEvaluate() throws TradingException {
      ...
      double var6 = var1.Value2.getRounded(this.Shift + 1);
      double var8 = var1.Value2.getRounded(this.Shift);
