...
@BuildingBlock(name = "QQE Value2 line is falling", display = "QQE(@Chart@#RSIPeriod#).Value2[#Shift#] is falling", returnType = 3)
...
public class QQEValue2Falling extends ConditionBlock {
   ...
   public boolean OnBlockEvaluate() throws TradingException {
      ...
      double var2 = var1.Value2.getRounded(this.Shift + 1);
