...
@BuildingBlock(name = "QQE Value1 line crosses above Level", display = "QQE(@Chart@#RSIPeriod#).Value1[#Shift#] crosses above #Level#", returnType = 3)
@SortOrder(500)
@OppositeBlock(value = "QQEValue1CrossBelow", oscillator = true, middleValue = 50.0, field = "Level")
