...
@BuildingBlock(name = "QQE Value1 line is lower than Level", display = "QQE(@Chart@#RSIPeriod#).Value1[#Shift#] < #Level#", returnType = 3)
@SortOrder(400)
@OppositeBlock(value = "QQEValue1Higher", oscillator = true, middleValue = 50.0, field = "Level")
