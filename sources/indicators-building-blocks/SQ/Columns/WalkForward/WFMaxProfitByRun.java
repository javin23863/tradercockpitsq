...
public class WFMaxProfitByRun extends WalkForwardColumn {
   public WFMaxProfitByRun() {
      super("WFMaxProfitByRun", L.tsq("Max profit in one run"), "Decimal2PL", (byte)1);
   }
   ...
   public double compute(WalkForwardResult var1) {
      ...
      if (!var2.isEmpty() && ((WalkForwardPeriod)var2.get(0)).runStatData != null) {
         ...
         for (int var5 = 0; var5 < var2.size(); var5++) {
            ...
            if (var6.runStatData != null && var6.runStatData.getDouble("NetProfit") > var3) {
               var3 = var6.runStatData.getDouble("NetProfit");
            }
         }
