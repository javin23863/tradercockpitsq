...
public class WFMaxDDbyRun extends WalkForwardColumn {
   public WFMaxDDbyRun() {
      super("WFMaxDDbyRun", L.tsq("Max Drawdown in one run"), "Decimal2PL", (byte)2);
   }
   ...
   public double compute(WalkForwardResult var1) {
      ...
      if (!var2.isEmpty() && ((WalkForwardPeriod)var2.get(0)).runStatData != null) {
         double var3 = ((WalkForwardPeriod)var2.get(0)).runStatData.getDouble("Drawdown");

         for (int var5 = 0; var5 < var2.size(); var5++) {
            WalkForwardPeriod var6 = (WalkForwardPeriod)var2.get(var5);
            if (var6.runStatData != null && var6.runStatData.getDouble("Drawdown") > var3) {
               var3 = var6.runStatData.getDouble("Drawdown");
            }
         }
