...
public class WFMaxStagnationInPct extends WalkForwardColumn {
   public WFMaxStagnationInPct() {
      super("WFMaxStagnationInPct", L.tsq("Max Stagnation in %"), "Decimal2Pct", (byte)2);
   }
   ...
   public double compute(WalkForwardResult var1) {
      ...
      if (!var2.isEmpty() && ((WalkForwardPeriod)var2.get(0)).runStatData != null) {
         double var3 = ((WalkForwardPeriod)var2.get(0)).runStatData.getDouble("StagnationPct");

         for (int var5 = 0; var5 < var2.size(); var5++) {
            WalkForwardPeriod var6 = (WalkForwardPeriod)var2.get(var5);
            if (var6.runStatData != null && var6.runStatData.getDouble("StagnationPct") > var3) {
               var3 = var6.runStatData.getDouble("StagnationPct");
            }
         }
