...
public class DateLastModified extends DatabankColumn {
   public DateLastModified() {
      super("Date last modified", "Time", (byte)2, 0.0, 0.0, 10000.0);
      this.setTooltip(L.tsq("Date last modified"));
      this.setWidth(150);
   ...
   public double getNumericValue(ResultsGroup var1, String var2, byte var3, byte var4, byte var5) throws Exception {
      return var1.specialValues().getLong(SpecialValues.DateLastModified, -1L);
   }
