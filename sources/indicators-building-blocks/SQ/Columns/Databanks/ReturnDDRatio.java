...
public class ReturnDDRatio extends DatabankColumn {
   public ReturnDDRatio() {
      super(L.tsq("Ret/DD Ratio"), "Decimal2", (byte)1, 0.0, -20.0, 20.0);
      this.setDependencies(new String[]{"NetProfit", "Drawdown", "NumberOfTrades"});
      this.setTooltip(L.tsq("Return / Drawdown Ratio"));
   }

   public double compute(SQStats var1, StatsTypeCombination var2, OrdersList var3, SettingsMap var4, SQStats var5, SQStats var6) throws Exception {
      double var7 = var1.getDouble("NetProfit");
      double var9 = Math.abs(var1.getDouble("Drawdown"));
