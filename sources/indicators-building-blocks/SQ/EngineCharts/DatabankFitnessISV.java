...
public class DatabankFitnessISV extends EngineChart {
   ...
   public DatabankFitnessISV() {
      super(L.tsq("Databank Fitness - IS Validation"), 50);
   ...
   private void addValueFromDatabank(Databank var1) {
      ...
      this.bestSeries.addValue(var3, var2.bestFitnessISV);
      this.topAvgSeries.addValue(var3, var2.topAvgFitnessISV);
      this.avgSeries.addValue(var3, var2.avgFitnessISV);
   }
