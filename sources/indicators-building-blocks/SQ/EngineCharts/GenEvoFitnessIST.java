...
public class GenEvoFitnessIST extends EngineChart {
   ...
   public GenEvoFitnessIST() {
      super(L.tsq("Island #1 - Fitness IS Training"), 50);
      ...
      this.best5AvgSeries = new TimeSeries(L.t("Top Ten Avg", new Object[0]), 1000);
   ...
   private void addValueFromGenEvo() {
      ...
      if (var1.isGeneticBuild()) {
         ...
         if (var8 != null && var8.length > 0) {
            ...
            if (var10 != null) {
               var2 = var10.bestFitnessIST;
               var4 = var10.topAvgFitnessIST;
               var6 = var10.avgFitnessIST;
            }
         }
      }
