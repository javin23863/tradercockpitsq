...
public class DatabankFitnessOOS extends EngineChart {
   ...
   public DatabankFitnessOOS() {
      super(L.tsq("Databank Fitness - OOS"), 50);
   ...
   private void addValueFromDatabank(Databank var1) {
      ...
      this.bestSeries.addValue(var3, var2.bestFitnessOOS);
      this.topAvgSeries.addValue(var3, var2.topAvgFitnessOOS);
      this.avgSeries.addValue(var3, var2.avgFitnessOOS);
   }
