...
public class DatabankFitnessIS extends EngineChart {
   ...
   public DatabankFitnessIS() {
      super(L.tsq("Databank Fitness - IS"), 50);
   ...
   private void addValueFromDatabank(Databank var1) {
      ...
      this.bestSeries.addValue(var3, var2.bestFitnessIS);
      this.topAvgSeries.addValue(var3, var2.topAvgFitnessIS);
      this.avgSeries.addValue(var3, var2.avgFitnessIS);
   }
