...
public class AverageStrategiesPerHourChart extends EngineChart {
   ...
   public AverageStrategiesPerHourChart() {
      super(L.tsq("Average strategies per hour"), 50);
      ...
      this.series = new TimeSeries(L.t("Avg. strategies per hour", new Object[0]), 1000);
   ...
   public void addNextValue() {
      try {
         ...
         this.series.addValue(System.currentTimeMillis(), this.projectRunInfo.strategiesPerHour);
