...
public class WinLossPLByWeekdayChart extends TradeAnalysisChart {
   public WinLossPLByWeekdayChart() {
      this.name = L.tsq("Wins/Losses Profit by weekday");
   }
   ...
   public AbstractChart draw(OrdersList var1, byte var2, byte var3) {
      ...
      for (int var6 = 0; var6 < var5.length; var6++) {
         var4.addValue("winners", this.dayToString(var6), var5[var6][0]);
         var4.addValue("losers", this.dayToString(var6), var5[var6][1]);
      }
   ...
   private double[][] computeData(OrdersList var1, byte var2, byte var3) {
      ...
      for (int var8 = 0; var8 < var1.size(); var8++) {
         ...
         int var10 = SQTime.getDayOfWeekOriginal(var9.getTimeByPeriodType(var3));
         double var6 = var9.getPLByType(var2);
         if (var6 > 0.0) {
            var4[var10][0] = var4[var10][0] + var6;
         } else {
            var4[var10][1] = var4[var10][1] + Math.abs(var6);
         }
      }
