...
public class WinLossCountByMonthChart extends TradeAnalysisChart {
   public WinLossCountByMonthChart() {
      this.name = L.tsq("Wins/Losses by month");
   }
   ...
   public AbstractChart draw(OrdersList var1, byte var2, byte var3) {
      ...
      for (int var6 = 0; var6 < var5.length; var6++) {
         var4.addValue("winners", this.monthToString(var6), var5[var6][0]);
         var4.addValue("losers", this.monthToString(var6), var5[var6][1]);
      }
