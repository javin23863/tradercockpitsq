...
public class MetaTrader5SimulatorHedging extends MetaTraderSimulatorHedging {
   private byte executionType;
   private SessionStatus marketOpenSessionStatus = new SessionStatus();

   public MetaTrader5SimulatorHedging(byte var1) {
      this.executionType = var1;
   }

   @Override
   public ITradingSimulator clone() {
      MetaTrader5SimulatorHedging var1 = new MetaTrader5SimulatorHedging(this.executionType);
