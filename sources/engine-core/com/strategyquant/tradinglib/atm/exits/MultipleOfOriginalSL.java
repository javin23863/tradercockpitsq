...
public class MultipleOfOriginalSL extends AbstractExitLevel {
   private double Multiplicator;

   public MultipleOfOriginalSL(Element var1, int var2) throws Exception {
      super(var1, var2);
   ...
   public Element getXML() {
      ...
      var1.setAttribute("key", "MultipleOfOriginalSL");
   ...
   public void setForOrder(ILiveOrder var1, StrategyBase var2, double var3, double var5) throws TradingException {
      if (var1.isFilled()) {
         ...
         this.setOrderPTValue(var1, var2, var3);
      }
   }
   ...
   public double getNettingPrice(StrategyBase var1, ILiveOrder var2, double var3, double var5) {
      ...
      double var10 = Math.abs(var8 - var3);
   ...
   public String toString() {
      return String.format("at %s x Original Stop Loss size", this.Multiplicator);
   }

   public static Element generate(IRandomGenerator var0, ATMGenerateConfig var1) {
      Element var2 = new Element("ExitLevel");
      var2.setAttribute("key", "MultipleOfOriginalSL");
      var2.setAttribute("use", "true");
      double var3 = var0.nextDouble(var1.slMultipleMin, var1.slMultipleMax, 0.05, 2);
