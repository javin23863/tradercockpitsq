...
public class Stagnation {
   public static final Logger Log = LoggerFactory.getLogger("Stagnation");
   ...
   public void print(EquityChart var1, ResultsGroup var2, String var3, OrdersList var4, byte var5, byte var6, byte var7, String var8) {
      try {
         ...
         int var10 = var9.stats(var5, var6, var7).getInt("Stagnation");
         long var11 = var9.stats(var5, var6, var7).getLong("StagnationFrom");
         long var13 = var9.stats(var5, var6, var7).getLong("StagnationTo");
         if (var10 == 0) {
            return;
         }
   ...
   private void printMarker(EquityChart var1, long var2, long var4, int var6) {
      ...
      var7.text = String.format("Max stagnation: %d days", var6);
      var7.verticalAlign = "bottom";
      var7.color = "#FFC0C0";
      var7.textColor = "#FF0000";
      var7.colorDark = "#883030";
      var7.xFrom = var2;
      var7.xTo = var4;
      var1.addArea(var7);
   }
