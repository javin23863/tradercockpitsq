...
@Name(name = "Brokers Plugin - SQ")
@Category(name = "Server Extension")
@License(text = "")
@ShortDesc(text = "Server API for brokers manipulation")
@PluginImplementation
public class BrokerServletPlugin implements IServletPlugin, IProgram {
   private BrokerServlet dataServlet;
   ...
   public void initPlugin() throws Exception {
      this.dataServlet = new BrokerServlet();
      Program.register("Brokers", this);
   }

   public Handler getHandler() {
      if (this.dataContext == null) {
         this.dataContext = new ServletContextHandler(1);
         this.dataContext.setContextPath("/brokers/");
