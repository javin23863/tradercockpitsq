package com.strategyquant.plugin.CryptoExchange.impl.BinanceUsdtM;
...
@Name(name = "BinanceUsdtM")
@Category(name = "Server Extension")
@License(text = "")
@ShortDesc(text = "Server API for managing Binance Usd-M data")
@PluginImplementation
public class CryptoExchangeBinanceUsdtMPlugin extends Exchange {
   ...
   public CryptoExchangeBinanceUsdtMPlugin() {
      (new Thread() {
         @Override
         public void run() {
            try {
               CryptoExchangeBinanceUsdtMPlugin.this.getSymbols();
   ...
   public JSONArray getSymbols() throws Exception {
      ...
      String var2 = new String(HttpApacheManager.getInstance().getData("https://fapi.binance.com/fapi/v1/exchangeInfo"), StandardCharsets.UTF_8);
      JSONObject var3 = new JSONObject(var2);
      JSONArray var4 = var3.getJSONArray("symbols");

      for (int var5 = 0; var5 < var4.length(); var5++) {
         String var6 = var4.getJSONObject(var5).getString("symbol");
         boolean var7 = var6.chars().allMatch(var0 -> var0 < 128);
         if (var7) {
            var1.put(var6);
         }
      }
   ...
   public IExchange clone() {
      return new CryptoExchangeBinanceUsdtMPlugin();
   }
   ...
   public void download() throws Exception {
      ...
      while (var9 <= this.importInfo.dateTo) {
         ...
         String var1 = "https://fapi.binance.com/fapi/v1/klines?symbol="
   ...
   private synchronized String getExchangeInfo() throws ClientProtocolException, IOException {
      ...
      this.exchangeInfo = new String(HttpApacheManager.getInstance().getData("https://fapi.binance.com/fapi/v1/exchangeInfo"));
      return this.exchangeInfo;
   }
