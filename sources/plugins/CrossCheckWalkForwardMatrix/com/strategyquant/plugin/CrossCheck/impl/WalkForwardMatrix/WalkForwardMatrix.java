package com.strategyquant.plugin.CrossCheck.impl.WalkForwardMatrix;
...
public class WalkForwardMatrix extends WalkForwardCrossCheckMethod {
   public static final Logger Log = LoggerFactory.getLogger("WalkForwardMatrix");
   private int distributionUp = 30;
   private int distributionDown = 30;
   private int maxSteps = 10;
   private ValuesMap paramTypesWFM = new ValuesMap();

   public WalkForwardMatrix() {
      super("WalkForwardMatrix_CrossCheck");
   }
   ...
   public String getShortName() {
      return L.tsq("WF matrix");
   }

   public String getDescription() {
      return L.tsq(
         "This cross check performs Walk-Forward Matrix evaluation of the strategy using the settings below.<br/>Be aware that WF Matrix is extremely slow, it consists of running a number of WF optimizations, which themselves are very slow."
      );
   }
   ...
   public void readSettings(Element var1, TaskSettingsData var2) throws Exception {
      ...
      this.optimizationSettings.param1Start = XMLUtil.getIntAttr(var6, "start", 10);
      this.optimizationSettings.param1Stop = XMLUtil.getIntAttr(var6, "stop", 40);
      this.optimizationSettings.param1Step = XMLUtil.getIntAttr(var6, "step", 10);
      this.optimizationSettings.param2Start = XMLUtil.getIntAttr(var7, "start", 10);
      this.optimizationSettings.param2Stop = XMLUtil.getIntAttr(var7, "stop", 20);
      this.optimizationSettings.param2Step = XMLUtil.getIntAttr(var7, "step", 5);
      ...
      this.paramTypesWFM = this.paramTypes.clone();
      ...
      try {
         ...
         this.optimizationSettings.thresholdPct = XMLUtil.getIntAttr(var10, "thresholdPct", 80);
         this.optimizationSettings.robCombRows = XMLUtil.getIntAttr(var10, "robCombRows", 3);
         this.optimizationSettings.robCombCols = XMLUtil.getIntAttr(var10, "robCombCols", 3);
         this.optimizationSettings.robMinComb = XMLUtil.getIntAttr(var10, "robMinComb", 7);
   ...
   protected SettingsMap prepareSettings(String var1, SettingsMap var2, Element var3, boolean var4) throws Exception {
      try {
         ...
         var7.transformToVariables(this.paramSymmetry, this.paramTypesWFM);
         ...
         throw new Exception(L.t("Error while preparing settings - %s", new Object[]{var12.getMessage()}));
      }
   }

   public ICrossCheck clone(SettingsMap var1) {
      WalkForwardMatrix var2 = new WalkForwardMatrix();
      ...
      var2.paramTypesWFM = this.paramTypes.clone();
      return var2;
   }
   ...
   public String printSettings(Element var1) throws Exception {
      ...
      String var5 = "";
      Element var6 = var3.getChild("Param1");
      Element var7 = var3.getChild("Param2");
      this.optimizationSettings.param1Start = XMLUtil.getIntAttr(var6, "start", 10);
      this.optimizationSettings.param1Stop = XMLUtil.getIntAttr(var6, "stop", 40);
      this.optimizationSettings.param1Step = XMLUtil.getIntAttr(var6, "step", 10);
      this.optimizationSettings.param2Start = XMLUtil.getIntAttr(var7, "start", 10);
      ...
      var5 = var5
         + OptimizationConst.printWFByPeriodType(
            var4,
            XMLUtil.getIntAttr(var7, "start", 10),
            XMLUtil.getIntAttr(var7, "step", 10),
            XMLUtil.getIntAttr(var7, "stop", 40),
            XMLUtil.getIntAttr(var6, "start", 10),
            XMLUtil.getIntAttr(var6, "step", 5),
            XMLUtil.getIntAttr(var6, "stop", 20)
         );
      var5 = var5 + "\n";
      ...
      var5 = var5 + "\n\n";
      Element var8 = var1.getChild("AcceptanceSettings");
      Element var9 = var8.getChild("Conditions");
      var5 = var5 + L.t("AreaRows: %s", new Object[]{XMLUtil.getIntAttr(var9, "robCombRows", 3)});
      var5 = var5 + "," + L.t("AreaCols: %s", new Object[]{XMLUtil.getIntAttr(var9, "robCombCols", 3)});
      var5 = var5 + "," + L.t("MinResults: %s", new Object[]{XMLUtil.getIntAttr(var9, "robCombCols", 7)});
      var5 = var5 + "," + L.t("ThresholdPct: %s", new Object[]{XMLUtil.getIntAttr(var9, "thresholdPct", 80)});
      var5 = var5 + "\n";
      ArrayList var10 = ProjectConfigHelper.getConditions(var9);

      for (int var11 = 0; var11 < var10.size(); var11++) {
         Condition var12 = (Condition)var10.get(var11);
         if (var12.isUsed()) {
            var5 = var5 + var12.toString();
            var5 = var5 + "\n";
         }
      }
