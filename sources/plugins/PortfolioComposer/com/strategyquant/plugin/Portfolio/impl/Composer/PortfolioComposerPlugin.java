...
@Name(name = "PortfolioComposer Servlet Plugin - SQ")
@Category(name = "Server Extension")
@License(text = "")
@ShortDesc(text = "Server API for builder")
@PluginImplementation
public class PortfolioComposerPlugin implements IServletPlugin {
   private ServletContextHandler dataContext;

   public String getProduct() {
      return "SQUANTPORTFOLIOCOMPOSER";
   }
   ...
   public Handler getHandler() {
      if (this.dataContext == null) {
         ...
         this.dataContext.setContextPath("/portfoliocomposer/");
         this.dataContext.addServlet(new ServletHolder(new PortfolioComposerServlet()), "/*");
      }
