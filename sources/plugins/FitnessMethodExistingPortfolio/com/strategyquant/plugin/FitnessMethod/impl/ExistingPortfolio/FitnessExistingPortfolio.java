package com.strategyquant.plugin.FitnessMethod.impl.ExistingPortfolio;
...
@Name(name = "Fitness Function ExistingPortfolio plugin")
@Category(name = "FitnessFunction")
@License(text = "")
@ShortDesc(text = "Short description")
@HideDatabankChoice
@PluginImplementation
public class FitnessExistingPortfolio implements IFitnessFunction, IServletPlugin {
   public static final Logger Log = LoggerFactory.getLogger(FitnessExistingPortfolio.class);
   private ServletContextHandler dataContext;
   private String databankColumnName = null;
   private ArrayList<FitnessExistingPortfolio.Goal> weightedGoals = new ArrayList<>();

   public FitnessExistingPortfolio() {
   }

   public FitnessExistingPortfolio(String var1) {
   ...
   private double getFitnessValue(ResultsGroup var1, byte var2, byte var3, String var4, double var5, byte var7, boolean var8) throws Exception {
      ...
      double var10 = var9.getNumericValue(var1, "Portfolio", var2, (byte)10, var3);
      ...
      SQStats var14 = var1.portfolio().statsOrNull((byte)0, (byte)10, var3);
      int var15 = 0;
      if (var14 != null) {
         var15 = var14.getInt("NumberOfTrades");
      }
   ...
   private double computeWeightedFitness(ResultsGroup var1, byte var2, byte var3, boolean var4) throws Exception {
      ...
      for (int var7 = 0; var7 < this.weightedGoals.size(); var7++) {
         FitnessExistingPortfolio.Goal var8 = this.weightedGoals.get(var7);
         if (var8.use) {
   ...
   public void initFitnessFromXml(Element var1) {
      ...
      for (Element var4 : var2.getChildren("Goal")) {
         FitnessExistingPortfolio.Goal var5 = new FitnessExistingPortfolio.Goal();
   ...
   public Handler getHandler() {
      if (this.dataContext == null) {
         ...
         this.dataContext.setContextPath("/fitnessExistingPortfolio/");
         this.dataContext.addServlet(new ServletHolder(new FitnessExistingPortfolioServlet()), "/*");
      }
   ...
   public String getFitnessName() {
      return L.tsq("Existing portfolio");
   }
   ...
   public ArrayList<DatabankColumn> getUsedStatValues() throws NonexistingCustomClassException {
      ...
      if (!this.databankColumnName.equals("Weighted")) {
         ...
         for (int var2 = 0; var2 < this.weightedGoals.size(); var2++) {
            FitnessExistingPortfolio.Goal var3 = this.weightedGoals.get(var2);
            if (var3.use) {
   ...
   public double getMetricValue(ResultsGroup var1, byte var2, byte var3, String var4) throws Exception {
      ...
      return var5.getNumericValue(var1, "Portfolio", var2, (byte)10, var3);
   }

   public IFitnessFunction clone() {
      FitnessExistingPortfolio var1 = new FitnessExistingPortfolio();
      var1.dataContext = this.dataContext;
      var1.databankColumnName = this.databankColumnName;
      var1.weightedGoals = this.cloneGoals();
      return var1;
   }

   private ArrayList<FitnessExistingPortfolio.Goal> cloneGoals() {
      ArrayList var1 = new ArrayList();

      for (int var2 = 0; var2 < this.weightedGoals.size(); var2++) {
         FitnessExistingPortfolio.Goal var3 = this.weightedGoals.get(var2);
         FitnessExistingPortfolio.Goal var4 = new FitnessExistingPortfolio.Goal();
