...
public class OverviewServletPlugin extends AbstractResultsPlugin {
   private ServletContextHandler dataContext;
   private OverviewServlet servlet;
   ...
   public Handler getHandler() {
      if (this.dataContext == null) {
         this.servlet = new OverviewServlet(this.rgProvider);
         this.dataContext = new ServletContextHandler(1);
         this.dataContext.setContextPath("/overview/");
   ...
   public JSONObject getInitializationData() throws Exception {
      ...
      var1.put("templates", this.servlet.getTemplates());
      return var1;
   }
}
