...
@Name(name = "Tradelist Servlet Plugin - SQ")
@Category(name = "Server Extension")
@License(text = "")
@ShortDesc(text = "Server API for results trade list tab")
@PluginImplementation
public class TradeListServletPlugin extends AbstractResultsPlugin {
   private ServletContextHandler dataContext;
   private TradeListServlet servlet;
   ...
   public Handler getHandler() {
      if (this.dataContext == null) {
         this.servlet = new TradeListServlet(this.rgProvider);
         this.dataContext = new ServletContextHandler(1);
         this.dataContext.setContextPath("/tradelist/");
         this.dataContext.addServlet(new ServletHolder(new TradeListServlet(this.rgProvider)), "/*");
      }
