...
public class OptResultsViews {
   private static final Logger Log = LoggerFactory.getLogger(OptResultsViews.class);
   private OptResultsViewsManager manager;

   public OptResultsViews(String var1) {
      this.manager = new OptResultsViewsManager(var1);
   }
   ...
   private String onGetViews() throws Exception {
      ...
      try {
         ...
         throw new Exception(L.t("Cannot get list of views.", new Object[0]), var12);
      }
   ...
   private String onAddView(Map<String, String[]> var1) throws Exception {
      ...
      try {
         ...
         throw new Exception(L.t("Cannot add view.", new Object[0]), var4);
      }
   ...
   private String onRemoveView(Map<String, String[]> var1) throws Exception {
      ...
      try {
         ...
         throw new Exception(L.t("Error while removing view.", new Object[0]), var4);
      }
