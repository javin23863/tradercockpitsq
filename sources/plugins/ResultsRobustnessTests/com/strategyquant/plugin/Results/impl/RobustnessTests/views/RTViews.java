...
public class RTViews {
   private static final Logger Log = LoggerFactory.getLogger(RTViews.class);
   private RTViewsManager manager;
   private String type;

   public RTViews(String var1, String var2) {
      this.type = var1;
      this.manager = new RTViewsManager(var1, var2);
   }
   ...
   private String onRemoveView(Map<String, String[]> var1) throws Exception {
      ...
      try {
         ...
         throw new Exception(L.t("Error while removing view.", new Object[]{var4}));
      }
