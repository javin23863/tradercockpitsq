package com.strategyquant.plugin.ProjectCondition.impl.GoToEvaluated;
...
@Name(name = "GoToEvaluated Condition plugin")
@Category(name = "Project Condition")
@License(text = "")
@ShortDesc(text = "Short description")
@PluginImplementation
public class GoToEvaluatedConditionPlugin implements IProjectCondition {
   public static final Logger Log = LoggerFactory.getLogger(GoToEvaluatedConditionPlugin.class);
   ...
   public String getName() {
      return " GoToEvaluated";
   }

   public String getTitle() {
      return L.tsq("Number of cycles (current Go To EVALUATED)");
   }
   ...
   public String getDescriptionFormat() {
      return L.t("Number of cycles (current Go To EVALUATED) %s %d", new Object[0]);
   }
   ...
   public boolean isMet(SQProject var1, ISQTask var2) throws Exception {
      double var3 = var2.getCustomValue("evaluatedCycles");
   ...
   public IProjectCondition clone() {
      GoToEvaluatedConditionPlugin var1 = new GoToEvaluatedConditionPlugin();
