package com.strategyquant.plugin.ProjectCondition.impl.GoToActivated;
...
@Name(name = "GoToActivated Condition plugin")
@Category(name = "Project Condition")
@License(text = "")
@ShortDesc(text = "Short description")
@PluginImplementation
public class GoToActivatedConditionPlugin implements IProjectCondition {
   public static final Logger Log = LoggerFactory.getLogger(GoToActivatedConditionPlugin.class);
   ...
   public String getName() {
      return " GoToActivated";
   }

   public String getTitle() {
      return L.tsq("Number of cycles (current Go To ACTIVATED)");
   }
   ...
   public String getDescriptionFormat() {
      return L.t("Number of cycles (current Go To ACTIVATED) %s %d", new Object[0]);
   }
   ...
   public boolean isMet(SQProject var1, ISQTask var2) throws Exception {
      double var3 = var2.getCustomValue("activatedCycles");
      this.lastCheckedValue = SQUtils.d2String(var3, 0);
   ...
   public IProjectCondition clone() {
      GoToActivatedConditionPlugin var1 = new GoToActivatedConditionPlugin();
