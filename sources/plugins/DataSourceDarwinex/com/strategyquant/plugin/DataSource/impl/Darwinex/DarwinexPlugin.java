...
@Name(name = "DarwinexPlugin")
@Category(name = "Server Extension")
@License(text = "")
@ShortDesc(text = "Server API for managing Darwinex data")
@PluginImplementation
public class DarwinexPlugin implements IServletPlugin, IProgram {
   private ServletContextHandler dataContext;
   private DarwinexServlet servlet;
   ...
   public void initPlugin() throws Exception {
      this.servlet = new DarwinexServlet();
      Program.register("DataSourceDarwinex", this);
   }

   public Handler getHandler() {
      if (this.dataContext == null) {
         this.dataContext = new ServletContextHandler(1);
         this.dataContext.setContextPath("/darwinex/");
         this.dataContext.addServlet(new ServletHolder(new DarwinexServlet()), "/*");
      }
