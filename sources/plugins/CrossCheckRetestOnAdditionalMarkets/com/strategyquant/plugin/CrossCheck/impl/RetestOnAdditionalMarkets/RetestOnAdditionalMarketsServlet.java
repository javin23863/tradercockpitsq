...
public class RetestOnAdditionalMarketsServlet extends HttpJSONServlet {
   private static final Logger Log = LoggerFactory.getLogger(RetestOnAdditionalMarketsServlet.class);
   ...
   @PrecachedRequest(relativeURL = "/retestOnAdditionalMarkets/list")
