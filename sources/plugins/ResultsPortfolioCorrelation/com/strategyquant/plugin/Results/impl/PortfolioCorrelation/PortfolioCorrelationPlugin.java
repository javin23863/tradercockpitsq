...
@Name(name = "PortfolioCorrelation Servlet Plugin - SQ")
@Category(name = "Server Extension")
@License(text = "")
@ShortDesc(text = "Server API for results Portfolio Correlation tab")
@PluginImplementation
public class PortfolioCorrelationPlugin extends AbstractResultsPlugin {
   private ServletContextHandler dataContext;
   private PortfolioCorrelationServlet servlet;
   ...
   public Handler getHandler() {
      if (this.dataContext == null) {
         this.servlet = new PortfolioCorrelationServlet(this.rgProvider);
         this.dataContext = new ServletContextHandler(1);
         this.dataContext.setContextPath("/portfoliocorrelation/");
