...
@Name(name = "Basket of Stocks Plugin - SQ")
@Category(name = "Server Extension")
@License(text = "")
@ShortDesc(text = "Server API for basket of stocks manipulation")
@PluginImplementation
public class BasketServletPlugin implements IServletPlugin, IProgram {
   private BasketServlet dataServlet;
   ...
   public void initPlugin() throws Exception {
      this.dataServlet = new BasketServlet();
      Program.register("GroupOfStocks", this);
   }

   public Handler getHandler() {
      if (this.dataContext == null) {
         this.dataContext = new ServletContextHandler(1);
         this.dataContext.setContextPath("/basketOfStocks/");
