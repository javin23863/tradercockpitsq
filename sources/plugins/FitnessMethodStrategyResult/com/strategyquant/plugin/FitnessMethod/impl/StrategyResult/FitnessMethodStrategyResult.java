...
@Name(name = "Fitness Function StrategyResult plugin")
@Category(name = "FitnessFunction")
@License(text = "")
@ShortDesc(text = "Short description")
@HideDatabankChoice
@PluginImplementation
public class FitnessMethodStrategyResult implements IFitnessFunction, IServletPlugin {
   public static final Logger Log = LoggerFactory.getLogger(FitnessMethodStrategyResult.class);
   private ServletContextHandler dataContext;
   private String databankColumnName = null;
   private ArrayList<FitnessMethodStrategyResult.Goal> weightedGoals = new ArrayList<>();

   public FitnessMethodStrategyResult() {
   }

   public FitnessMethodStrategyResult(String var1) {
   ...
   private double getFitnessValue(ResultsGroup var1, byte var2, byte var3, String var4, double var5, byte var7, boolean var8) throws Exception {
      ...
      double var10 = var9.getNumericValue(var1, var1.getMainResultKey(), var2, (byte)10, var3);
      ...
      SQStats var14 = var1.mainResult().statsOrNull((byte)0, (byte)10, var3);
      int var15 = 0;
      if (var14 != null) {
   ...
   private double computeWeightedFitness(ResultsGroup var1, byte var2, byte var3, boolean var4) throws Exception {
      ...
      for (int var7 = 0; var7 < this.weightedGoals.size(); var7++) {
         FitnessMethodStrategyResult.Goal var8 = this.weightedGoals.get(var7);
         if (var8.use) {
   ...
   public void initFitnessFromXml(Element var1) {
      ...
      for (Element var4 : var2.getChildren("Goal")) {
         FitnessMethodStrategyResult.Goal var5 = new FitnessMethodStrategyResult.Goal();
   ...
   public Handler getHandler() {
      if (this.dataContext == null) {
         ...
         this.dataContext.setContextPath("/fitnessMethodStrategyResult/");
         this.dataContext.addServlet(new ServletHolder(new FitnessMethodStrategyResultServlet()), "/*");
      }
   ...
   public ArrayList<DatabankColumn> getUsedStatValues() throws NonexistingCustomClassException {
      ...
      if (!this.databankColumnName.equals("Weighted")) {
         ...
         for (int var2 = 0; var2 < this.weightedGoals.size(); var2++) {
            FitnessMethodStrategyResult.Goal var3 = this.weightedGoals.get(var2);
            if (var3.use) {
   ...
   public double getMetricValue(ResultsGroup var1, byte var2, byte var3, String var4) throws Exception {
      ...
      return var5.getNumericValue(var1, var1.getMainResultKey(), var2, (byte)10, var3);
   }

   public IFitnessFunction clone() {
      FitnessMethodStrategyResult var1 = new FitnessMethodStrategyResult();
   ...
   private ArrayList<FitnessMethodStrategyResult.Goal> cloneGoals() {
      ArrayList var1 = new ArrayList();

      for (int var2 = 0; var2 < this.weightedGoals.size(); var2++) {
         FitnessMethodStrategyResult.Goal var3 = this.weightedGoals.get(var2);
         FitnessMethodStrategyResult.Goal var4 = new FitnessMethodStrategyResult.Goal();
