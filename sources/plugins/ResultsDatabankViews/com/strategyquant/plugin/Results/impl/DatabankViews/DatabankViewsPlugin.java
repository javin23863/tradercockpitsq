...
@Name(name = "Databank views Servlet Plugin - SQ")
@Category(name = "Server Extension")
@License(text = "")
@ShortDesc(text = "Server API for databank views management")
@PluginImplementation
public class DatabankViewsPlugin implements IServletPlugin {
   ...
   public Handler getHandler() {
      if (this.dataContext == null) {
         ...
         this.dataContext.setContextPath("/dbviews/");
         this.dataContext.addServlet(new ServletHolder(new DatabankViewsServlet()), "/*");
      }
