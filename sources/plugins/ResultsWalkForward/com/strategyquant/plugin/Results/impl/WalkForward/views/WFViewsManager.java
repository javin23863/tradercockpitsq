...
public class WFViewsManager {
   private static final Logger Log = LoggerFactory.getLogger(WFViewsManager.class);
   ...
   public static final String SettingsKey = "wfResultsView";
   private final String DefaultViewName = "Default";

   public WFViewsManager(String var1) {
      this.viewsFolder = var1;
      this.loadViews();
   }
   ...
   public DatabankTableView createDefaultView() {
      ...
      String[] var2 = new String[]{"NumberOfTrades", "NetProfit", "Drawdown"};
      ...
      for (String var7 : var2) {
         for (DatabankColumn var9 : var3) {
            if (var9.getClass().getSimpleName().equals(var7)) {
               var1.columns.add(new DatabankTableColumnEntry(var9, "main", (byte)0, (byte)10, (byte)10));
               var1.columns.add(new DatabankTableColumnEntry(var9, "main", (byte)0, (byte)10, (byte)20));
               break;
            }
         }
      }
   ...
   public DatabankTableView getSelectedView() {
      String var1 = MainApp.settings().get("wfResultsView");
      if (var1 != null) {
         try {
            return this.getView(var1);
         } catch (Exception var4) {
            Log.error("Cannot load selected WF view. Using default view...");
         }
      }
      ...
      try {
         ...
         Log.error("Cannot load default WF view");
         return null;
      }
   }
}
