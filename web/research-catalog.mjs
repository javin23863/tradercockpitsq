...
// carries the platform-owned Machine Learning / Models modality (`/api/research/models`).
...
function modelsTab() {
  return `<div class="with-rail">${card({
    ...
    headIcon: "bot",
    accent: "purple",
    body: `<div data-ml-models>${unavailable("Checking Models backend", "Platform-owned sklearn families appear when /api/research/models answers. Outputs stay out of SQX Builder/backtest/robustness.", { compact: true, tone: "pending" })}</div>`,
