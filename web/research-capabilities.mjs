...
const CAPABILITIES = Object.freeze([
  ...
  Object.freeze({
    ...
    detail: "Inspects the currently exposed native strategy/market shape, one data setup, trading options, exact producer-owned Blocks subtree, money-management presence, exact native search selector plus opaque BuildMode structure, and presents Random Discovery and Genetic Evolution as distinct read-only workflow lanes while keeping block taxonomy/parameters, ranking stop/max, and CrossChecks state producer-owned.",
  }),
  Object.freeze({
