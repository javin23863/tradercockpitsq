...
const CAPABILITIES = Object.freeze([
  ...
  Object.freeze({
    ...
    surface: null,
    route: null,
    detail: "The backend exposes exact source-bound Forex, Futures, and Stocks preset inspection, but no TraderCockpit desktop inspector or selection control consumes this read model yet.",
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    surface: null,
    route: null,
    detail: "The backend exposes immutable numbered native task topology and typed ClearDatabanks/GoToTask details, but no canonical desktop surface consumes this read model yet; native execution remains unsupported by this topology API.",
  }),
  Object.freeze({
    id: "research_proof",
