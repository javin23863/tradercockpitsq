...
4. identify which native SQX module owns the operation;
5. identify exactly what TraderCockpit must configure/control/read/persist/present;
...
2. compare it with the native SQX authority and TraderCockpit UI authority;
...
Any older repository instruction requiring TraderCockpit-owned reproduction of SQX producer algorithms is superseded by this file and `docs/product-architecture-v1.md`.