...
# Backend: exact byte handoffs + serialized duplicate detection.
replace(
    "product/tradercockpit/research_proof.py",
...
# Frontend: stale bookmarked read and obsolete async creation must not overwrite newer truth.
replace(
    "web/research-proof.mjs",
...
# Backend regressions: fill the canonical byte identities and exercise substitutions/concurrency.
replace(
    "tests/product/test_research_proof.py",
    "from pathlib import Path\n",
