...
public class AvgPctDrawdown extends DatabankColumn {
	...
	public AvgPctDrawdown() {
		super(L.tsq("Avg. % Drawdown"), DatabankColumn.Decimal2Pct, ValueTypes.Minimize, 0, 0, 10000);
	...
	public double compute(SQStats stats, StatsTypeCombination combination, OrdersList ordersList, SettingsMap settings, SQStats statsLong, SQStats statsShort) throws Exception {
		// already computed in DrawdownPct
		return stats.getDouble("AvgPctDrawdown");
	}
