...
public class SlippageInMoney extends DatabankColumn {
    
	public SlippageInMoney() {
		super(L.tsq("Slippage ($)"), DatabankColumn.Decimal2PL, ValueTypes.Maximize, 0, -10000, 10000);
