...
public class Symmetry extends DatabankColumn {
    
	public Symmetry() {
		super(L.tsq("Symmetry"), DatabankColumn.Decimal2Pct, ValueTypes.Maximize, 0, 0, 100);

		setTooltip(L.tsq("How symmetrical is profit between Long and Short side?"));
	...
	private double computeSymmetry(double longPL, double shortPL) {
		...
		// now one of the PLs is positive, another negative. Symmetry is 0
		return 0;
	}	
}