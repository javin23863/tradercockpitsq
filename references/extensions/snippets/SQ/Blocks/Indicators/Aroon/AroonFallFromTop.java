...
@BuildingBlock(name="Aroon Down falls from top", display="Aroon(@Chart@#Period#).Down[#Shift#] falls from top", returnType = ReturnTypes.Boolean)
...
public class AroonFallFromTop extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		return (down1 == 100) && (down0 < 100) && (up0 < 70);
	}
