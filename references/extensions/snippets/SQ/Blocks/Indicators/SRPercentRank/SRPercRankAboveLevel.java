...
@BuildingBlock(name="(PRAL) SR Percent Rank is above Level", display=" SR Percent Rank(@Chart@#Mode#,#Length#,#ATRPeriod#)[#Shift#] is above #Level#", returnType = ReturnTypes.Boolean)
@Help("Is triggered if SRPercentRank is below Level")
@OppositeBlock("SRPercRankAboveLevel") /// this is correct 
...
public class SRPercRankAboveLevel extends ConditionBlock {
	...
	@Parameter(defaultValue="80", isPeriod=true, minValue=0, maxValue=99.5, step=0.5)
	public double Level;
