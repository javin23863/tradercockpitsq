...
@BuildingBlock(name="(ROCAL) ROC is above Level", display="ROC(@Chart@#Period#)[#Shift#] is above #Level#", returnType = ReturnTypes.Boolean)
@Help("Is triggered if ROC is above Level")
@OppositeBlock(value="ROCBelowLevel",oscillator=true, middleValue=0, field="Level")
...
public class ROCAboveLevel extends ConditionBlock {
