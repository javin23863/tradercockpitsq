...
@BuildingBlock(name="(ROCF) ROC is falling", display="ROC(@Chart@#Period#)[#Shift#] is falling", returnType = ReturnTypes.Boolean)
@Help("Is triggered if ROC is falling")
@OppositeBlock("ROCRising")
...
public class ROCFalling extends ConditionBlock {
