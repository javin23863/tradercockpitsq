...
@BuildingBlock(name="ADX is lower than Level", display="ADX(@Chart@#Period#)[#Shift#] < #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="ADXLower", middleValue=50, field="Level")
@SortOrder(400)
...
public class ADXLower extends ConditionBlock {
