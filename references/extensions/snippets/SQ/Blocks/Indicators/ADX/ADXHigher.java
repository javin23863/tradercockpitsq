...
@BuildingBlock(name="ADX is higher than Level", display="ADX(@Chart@#Period#)[#Shift#] > #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="ADXHigher", middleValue=50, field="Level")
@SortOrder(300)
...
public class ADXHigher extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double value = indicator.Main.getRounded(Shift);
