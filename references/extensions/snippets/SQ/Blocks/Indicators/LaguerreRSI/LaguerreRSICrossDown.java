...
@BuildingBlock(name="(LRSID) Laguerre RSI crosses below Level", display="Laguerre RSI(@Chart@#Gamma#)[#Shift#] crosses below #Level#", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Laguerre RSI crosses below Level")
@OppositeBlock(value="LaguerreRSICrossUP", oscillator=true, middleValue=0.5, field="Level")
...
public class LaguerreRSICrossDown extends ConditionBlock {
