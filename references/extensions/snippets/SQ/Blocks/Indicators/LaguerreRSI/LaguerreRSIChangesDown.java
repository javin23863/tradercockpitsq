...
@BuildingBlock(name="(LRSICD) Laguerre RSI changes direction downwards", display="Laguerre RSI(@Chart@#Gamma#)[#Shift#] changes direction downwards", returnType = ReturnTypes.Boolean)
