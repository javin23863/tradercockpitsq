...
@BuildingBlock(name="Awesome Oscillator changes direction upwards", display="AwesomeOscillator(@Chart@)[#Shift#] changes direction upwards", returnType = ReturnTypes.Boolean)
