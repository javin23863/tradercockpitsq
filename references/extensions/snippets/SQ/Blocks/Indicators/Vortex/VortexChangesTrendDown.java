...
@BuildingBlock(name="(VCD) Vortex Changes Trend Down", display="Vortex(@Chart@#Period#)[#Shift#] Changes Trend Down", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Vortex changes direction downwards")
@OppositeBlock("VortexChangesTrendUP")
...
public class VortexChangesTrendDown extends ConditionBlock {
