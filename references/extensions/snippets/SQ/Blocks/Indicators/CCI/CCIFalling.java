...
@BuildingBlock(name="CCI is falling", display="CCI(@Chart@#Period#)[#Shift#] is falling", returnType = ReturnTypes.Boolean)
@Help("Is triggered if CCI is falling")
@OppositeBlock("CCIRising")
@SortOrder(200)
...
public class CCIFalling extends ConditionBlock {
