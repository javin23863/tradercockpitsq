...
@BuildingBlock(name="(WTD) Woodies Trend Down", display="Woodies Trend Down(@Chart@#Period#)[#Shift#]", returnType = ReturnTypes.Boolean)
@Help("Is triggered if WCCI is 6 consecutive bars below 0")
@OppositeBlock("WoodiesTrendUP")
...
public class WoodiesTrendDown extends ConditionBlock {
