...
@BuildingBlock(name="CCI is lower than Level", display="CCI(@Chart@#Period#)[#Shift#] < #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(400)
@OppositeBlock(value="CCIHigher", oscillator=true, middleValue=0, field="Level")
