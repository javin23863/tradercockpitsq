...
@BuildingBlock(name="CCI crosses below Level", display="CCI(@Chart@#Period#)[#Shift#] crosses below #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(600)
@OppositeBlock(value="CCICrossUp", oscillator=true, middleValue=0, field="Level")
