...
@BuildingBlock(name="CCI is rising", display="CCI(@Chart@#Period#)[#Shift#] is rising", returnType = ReturnTypes.Boolean)
@Help("Is triggered if CCI is rising")
@OppositeBlock("CCIFalling")
@SortOrder(100)
@CategoryOrder(600)
...
public class CCIRising extends ConditionBlock {
