...
@BuildingBlock(name="CCI is higher than Level", display="CCI(@Chart@#Period#)[#Shift#] > #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(300)
@OppositeBlock(value="CCILower", oscillator=true, middleValue=0, field="Level")
...
public class CCIHigher extends ConditionBlock {
	...
	@Parameter(defaultValue="0", minValue=-5000, maxValue=5000, builderMinValue=-500, builderMaxValue=500, step=5)
	public double Level;
