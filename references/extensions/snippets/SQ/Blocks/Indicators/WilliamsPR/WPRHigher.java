...
@BuildingBlock(name="Williams%R is higher than Level", display="Williams%R(@Chart@#Period#)[#Shift#] > #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="WPRLower", oscillator=true, middleValue=-50, field="Level")
@SortOrder(300)
