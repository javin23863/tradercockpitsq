...
@BuildingBlock(name="Williams%R crosses below Level", display="Williams%R(@Chart@#Period#)[#Shift#] crosses below #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="WPRCrossUp", oscillator=true, middleValue=-50, field="Level")
@SortOrder(600)
...
public class WPRCrossDown extends ConditionBlock {
	...
	@Parameter(defaultValue="0", minValue=-100, maxValue=0, step=0.5)
	public double Level;
	...
	public boolean OnBlockEvaluate() throws TradingException {
		WilliamsPR indicator = Strategy.Indicators.WilliamsPR(Input, Period);
