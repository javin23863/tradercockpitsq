 ...
 */
@BuildingBlock(name="(Ichimoku) Senkou Span cross bullish", display="Ichimoku(@Chart@#TenkanPeriod#,#KijunPeriod#,#SenkouPeriod#)[#Shift#] Senkou Span cross bullish", returnType = ReturnTypes.Boolean)
@OppositeBlock("IchimokuSenkouSpanCrossBearish")
...
public class IchimokuSenkouSpanCrossBullish extends ConditionBlock {
