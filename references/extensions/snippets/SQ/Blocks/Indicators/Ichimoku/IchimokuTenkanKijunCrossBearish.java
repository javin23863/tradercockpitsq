 ...
 */
@BuildingBlock(name="(Ichimoku) TenkanSen crosses KijunSen bearish ", display="Ichimoku(@Chart@#TenkanPeriod#,#KijunPeriod#,#SenkouPeriod#)[#Shift#] TenkanSen crosses KijunSen bearish", returnType = ReturnTypes.Boolean)
