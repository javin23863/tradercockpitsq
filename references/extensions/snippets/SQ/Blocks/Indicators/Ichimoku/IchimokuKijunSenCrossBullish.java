 ...
 */
@BuildingBlock(name="(Ichimoku) price crosses KijunSen bullish", display="Ichimoku(@Chart@#TenkanPeriod#,#KijunPeriod#,#SenkouPeriod#)[#Shift#] price crosses KijunSen bullish", returnType = ReturnTypes.Boolean)
