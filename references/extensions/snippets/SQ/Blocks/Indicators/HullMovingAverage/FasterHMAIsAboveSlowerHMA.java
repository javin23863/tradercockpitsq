...
@BuildingBlock(name="(FAS) Fast HMA Is Above Slow HMA", display="Fast HMA(@Chart@#FasterPeriod#)[#Shift#] Is Above Slow HMA(@Chart@#SlowerPeriod#)[#Shift#]", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Faster HMA Is Above Slower HMA")
@OppositeBlock("FasterHMAIsBelowSlowerHMA")
...
@MT5ExtendedTemplate
public class FasterHMAIsAboveSlowerHMA extends ConditionBlock {
