...
@BuildingBlock(name="(LWMA) Linear Weighted Moving Average", display="LWMA(@Chart@#Period#)[#Shift#]", returnType = ReturnTypes.Price)
@Help("Linear Weighted Moving Average")
...
public class LWMA extends IndicatorBlock {
	...
	@Output(name = "LWMA", color = Colors.Red)
	...
	protected void OnInit() throws TradingException {
		averageCalculator = new AverageCalculator(AverageCalculator.LWMA, Period);
	}
