...
@BuildingBlock(name="(SMMA) Smoothed Moving Average", display="SMMA(@Chart@#Period#)[#Shift#]", returnType = ReturnTypes.Price)
@Help("Smoothed Moving Average")
...
public class SMMA extends IndicatorBlock {
	...
	@Output(name = "SMMA", color = Colors.Red)
	...
	protected void OnInit() throws TradingException {
		averageCalculator = new AverageCalculator(AverageCalculator.SMMA, Period);
	}
