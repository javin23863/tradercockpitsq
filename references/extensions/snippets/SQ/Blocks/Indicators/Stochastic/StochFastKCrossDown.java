...
@BuildingBlock(name="Stochastic.Fast %K crosses below Level", display="Stoch(@Chart@#KPeriod#, #DPeriod#, #Slowing#).Fast %K[#Shift#] crosses below #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(600)
@OppositeBlock(value="StochFastKCrossUp", oscillator=true, middleValue=50, field="Level")
