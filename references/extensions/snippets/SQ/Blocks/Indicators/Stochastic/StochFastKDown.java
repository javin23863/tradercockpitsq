...
@BuildingBlock(name="Stochastic.Fast %K is lower than Slow %D", display="Stoch(@Chart@#KPeriod#, #DPeriod#, #Slowing#).Fast %K[#Shift#] is lower than Stoch(@Chart@#KPeriod#, #DPeriod#, #Slowing#).Slow %D", returnType = ReturnTypes.Boolean)
@SortOrder(100)
@OppositeBlock("StochFastKUp")
...
public class StochFastKDown extends ConditionBlock {
