...
@BuildingBlock(name="Stochastic.Fast %K crosses above Level", display="Stoch(@Chart@#KPeriod#, #DPeriod#, #Slowing#).Fast %K[#Shift#] crosses above #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(500)
@OppositeBlock(value="StochFastKCrossDown", oscillator=true, middleValue=50, field="Level")
...
public class StochFastKCrossUp extends ConditionBlock {
	...
	@Parameter(defaultValue="0", minValue=0, maxValue=100, step=0.5)
	public double Level;
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double value1 = indicator.FastK.getRounded(Shift + 1);
		double value2 = indicator.FastK.getRounded(Shift);
