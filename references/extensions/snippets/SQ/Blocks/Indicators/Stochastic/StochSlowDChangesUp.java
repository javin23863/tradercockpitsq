...
@BuildingBlock(name="Stochastic.Slow %D changes direction upwards", display="Stoch(@Chart@#KPeriod#, #DPeriod#, #Slowing#).Slow %D[#Shift#] changes direction upwards", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Stochastic changes direction upwards")
@SortOrder(700)
@OppositeBlock("StochSlowDChangesDown")
...
public class StochSlowDChangesUp extends ConditionBlock {
