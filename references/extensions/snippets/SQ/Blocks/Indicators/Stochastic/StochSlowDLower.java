...
@BuildingBlock(name="Stochastic.Slow %D is lower than Level", display="Stoch(@Chart@#KPeriod#, #DPeriod#, #Slowing#).Slow %D[#Shift#] < #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(400)
@OppositeBlock(value="StochSlowDHigher", oscillator=true, middleValue=50, field="Level")
...
public class StochSlowDLower extends ConditionBlock {
