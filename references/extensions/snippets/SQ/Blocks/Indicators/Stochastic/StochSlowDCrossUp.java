...
@BuildingBlock(name="Stochastic.Slow %D crosses above Level", display="Stoch(@Chart@#KPeriod#, #DPeriod#, #Slowing#).Slow %D[#Shift#] crosses above #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(500)
@OppositeBlock(value="StochSlowDCrossDown", oscillator=true, middleValue=50, field="Level")
...
public class StochSlowDCrossUp extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double value1 = indicator.SlowD.getRounded(Shift + 1);
