...
@BuildingBlock(name="Stochastic.Slow %D crosses below Level", display="Stoch(@Chart@#KPeriod#, #DPeriod#, #Slowing#).Slow %D[#Shift#] crosses below #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(600)
@OppositeBlock(value="StochSlowDCrossUp", oscillator=true, middleValue=50, field="Level")
...
public class StochSlowDCrossDown extends ConditionBlock {
