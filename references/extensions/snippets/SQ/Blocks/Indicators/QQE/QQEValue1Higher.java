...
@BuildingBlock(name="QQE Value1 line is higher than Level", display="QQE(@Chart@#RSIPeriod#).Value1[#Shift#] > #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(300)
@OppositeBlock(value="QQEValue1Lower", oscillator=true, middleValue=50, field="Level")
