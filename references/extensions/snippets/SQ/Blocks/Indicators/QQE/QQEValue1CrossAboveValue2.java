...
@BuildingBlock(name="QQE Value1 line crosses above Value2", display="QQE(@Chart@#RSIPeriod#).Value1[#Shift#] crosses above QQE.Value2", returnType = ReturnTypes.Boolean)
@SortOrder(500)
@OppositeBlock("QQEValue1CrossBelowValue2")
@ParameterSet(set="RSIPeriod=14,sF=5,wF=4.236")
public class QQEValue1CrossAboveValue2 extends ConditionBlock {
