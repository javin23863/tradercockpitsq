...
@BuildingBlock(name="QQE Value1 line changes direction downwards", display="QQE(@Chart@#RSIPeriod#).Value1[#Shift#] changes direction downwards", returnType = ReturnTypes.Boolean)
