...
@BuildingBlock(name="QQE Value1 line is falling", display="QQE(@Chart@#RSIPeriod#).Value1[#Shift#] is falling", returnType = ReturnTypes.Boolean)
@Help("Is triggered if QQE Value1 is falling")
@SortOrder(200)
@OppositeBlock("QQEValue1Rising")
@ParameterSet(set="RSIPeriod=14,sF=5,wF=4.236")
public class QQEValue1Falling extends ConditionBlock {
