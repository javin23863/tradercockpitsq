...
@BuildingBlock(name="QQE Value1 line crosses above Level", display="QQE(@Chart@#RSIPeriod#).Value1[#Shift#] crosses above #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(500)
@OppositeBlock(value="QQEValue1CrossBelow", oscillator=true, middleValue=50, field="Level")
@ParameterSet(set="RSIPeriod=14,sF=5,wF=4.236")
public class QQEValue1CrossAbove extends ConditionBlock {
	...
	@Parameter(defaultValue="0", minValue=0, maxValue=100, step=5, builderMinValue=0, builderMaxValue=100, builderStep=0.25)
	public double Level;
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double value1 = indicator.Value1.getRounded(Shift + 1);
		double value2 = indicator.Value1.getRounded(Shift);
