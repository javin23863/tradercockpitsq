...
@BuildingBlock(name="Bears Power crosses above Level", display="BearsPower(@Chart@#Period#)[#Shift#] crosses above #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="BUPCrossDown", oscillator=true, middleValue=0, field="Level")
@SortOrder(500)
