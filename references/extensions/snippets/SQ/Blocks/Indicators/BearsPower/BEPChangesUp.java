...
@BuildingBlock(name="Bears Power changes direction upwards", display="BearsPower(@Chart@#Period#)[#Shift#] changes direction upwards", returnType = ReturnTypes.Boolean)
