...
@BuildingBlock(name="(AVWAPR) Anchored VWAP is rising", display="AnchoredVWAP(@Chart@#SessionType#,#StdDevMult#)[#Shift#] is rising", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Anchored VWAP is rising")
@ForEngine("MT4,MT5,TS,MC")
@OppositeBlock("AnchoredVWAPFalling")
...
public class AnchoredVWAPRising extends ConditionBlock {
