...
@BuildingBlock(name="(MTKC) MT Keltner Channel", display="MT Keltner Channel(@Chart@#Period#, #Deviation#).#Line#[#Shift#]", returnType = ReturnTypes.Price)
...
public class MTKeltnerChannel extends IndicatorBlock {
	...
	@Parameter(defaultValue="1.5", minValue=0.01, maxValue=10, step=0.01, builderMinValue=0.5, builderMaxValue=3, builderStep=0.1)
	...
	protected void OnBarUpdate() throws TradingException {
		middleAverageCalculator.onBarUpdate(Input.Close.get(0), getCurrentBar());
