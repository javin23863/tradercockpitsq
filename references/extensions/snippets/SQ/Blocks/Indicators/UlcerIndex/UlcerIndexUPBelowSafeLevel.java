...
@BuildingBlock(name="(UIUS) Ulcer Index UP Below Safe Level", display="Ulcer Index UP(@Chart@#Mode#,#Period#)[#Shift#] is Below #SafeLevel#", returnType = ReturnTypes.Boolean)
