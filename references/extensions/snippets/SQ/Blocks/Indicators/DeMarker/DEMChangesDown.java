...
@BuildingBlock(name="DeMarker changes direction downwards", display="DeMarker(@Chart@#Period#)[#Shift#] changes direction downwards", returnType = ReturnTypes.Boolean)
