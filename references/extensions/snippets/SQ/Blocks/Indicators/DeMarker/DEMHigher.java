...
@BuildingBlock(name="DeMarker is higher than Level", display="DeMarker(@Chart@#Period#)[#Shift#] > #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="DEMLower", oscillator=true, middleValue=0.5, field="Level")
@SortOrder(300)
...
public class DEMHigher extends ConditionBlock {
