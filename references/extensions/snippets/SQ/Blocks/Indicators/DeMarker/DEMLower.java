...
@BuildingBlock(name="DeMarker is lower than Level", display="DeMarker(@Chart@#Period#)[#Shift#] < #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="DEMHigher", oscillator=true, middleValue=0.5, field="Level")
@SortOrder(400)
...
public class DEMLower extends ConditionBlock {
