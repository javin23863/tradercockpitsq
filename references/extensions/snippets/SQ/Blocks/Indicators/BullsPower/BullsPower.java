...
@BuildingBlock(name="(BUP) Bulls Power", display="BullsPower(@Chart@#Period#, #ComputedFrom#)[#Shift#]", returnType = ReturnTypes.Number)
...
public class BullsPower extends IndicatorBlock {
	...
	protected void OnBarUpdate() throws TradingException {
		...
		Value.set(0, Input.High.get(0) - averageCalculator.getValue());
	}
