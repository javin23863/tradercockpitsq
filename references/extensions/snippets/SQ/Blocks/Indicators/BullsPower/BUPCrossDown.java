...
@BuildingBlock(name="Bulls Power crosses below Level", display="BullsPower(@Chart@#Period#)[#Shift#] crosses below #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="BEPCrossUp", oscillator=true, middleValue=0, field="Level")
@SortOrder(600)
...
public class BUPCrossDown extends ConditionBlock {
	...
	@Parameter(defaultValue="0", minValue=-5000, maxValue=5000, step=0.001, builderMinValue=-5, builderMaxValue=5, builderStep=0.001)
	public double Level;
	...
	public boolean OnBlockEvaluate() throws TradingException {
		BullsPower indicator = Strategy.Indicators.BullsPower(Input, Period, ComputedFrom);
