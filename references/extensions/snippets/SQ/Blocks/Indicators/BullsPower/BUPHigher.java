...
@BuildingBlock(name="Bulls Power is higher than Level", display="BullsPower(@Chart@#Period#)[#Shift#] > #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="BEPLower", oscillator=true, middleValue=0, field="Level")
@SortOrder(300)
