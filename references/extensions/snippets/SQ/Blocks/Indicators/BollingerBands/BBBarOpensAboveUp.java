...
@BuildingBlock(name="(BB) Bar opens above Upper band", display="Bar opens above BB(@Chart@#Period#, #Deviation#).Upper[#Shift#]", returnType = ReturnTypes.Boolean)
@OppositeBlock("BBBarOpensBelowDown")
...
public class BBBarOpensAboveUp extends ConditionBlock {
