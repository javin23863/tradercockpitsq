...
@BuildingBlock(name="(BB) Bar opens above Upper band after opened below", display="Bar opens above BB(@Chart@#Period#, #Deviation#).Upper[#Shift#] after opened below", returnType = ReturnTypes.Boolean)
@OppositeBlock("BBBarOpensBelowDownAfterOpenAbove")
...
public class BBBarOpensAboveUpAfterOpenBelow extends ConditionBlock {
