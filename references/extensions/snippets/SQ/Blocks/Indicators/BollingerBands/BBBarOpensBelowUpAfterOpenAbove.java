...
@BuildingBlock(name="(BB) Bar opens below Upper band after opened above", display="Bar opens below BB(@Chart@#Period#, #Deviation#).Upper[#Shift#] after opened above", returnType = ReturnTypes.Boolean)
@OppositeBlock("BBBarOpensAboveDownAfterOpenBelow")
...
public class BBBarOpensBelowUpAfterOpenAbove extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		double value1 = Strategy.Indicators.BollingerBands(Chart.getSeries(ComputedFrom), Period, Deviation).Upper.getRounded(Shift+1);
