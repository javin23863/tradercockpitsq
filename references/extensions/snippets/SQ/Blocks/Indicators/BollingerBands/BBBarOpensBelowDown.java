...
@BuildingBlock(name="(BB) Bar opens below Lower band", display="Bar opens below BB(@Chart@#Period#, #Deviation#).Lower[#Shift#]", returnType = ReturnTypes.Boolean)
@OppositeBlock("BBBarOpensAboveUp")
...
public class BBBarOpensBelowDown extends ConditionBlock {
