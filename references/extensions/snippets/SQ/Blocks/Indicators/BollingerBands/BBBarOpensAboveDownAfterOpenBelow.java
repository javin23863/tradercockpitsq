...
@BuildingBlock(name="(BB) Bar opens above Lower band after opened below", display="Bar opens above BB(@Chart@#Period#, #Deviation#).Lower[#Shift#] after opened below", returnType = ReturnTypes.Boolean)
@OppositeBlock("BBBarOpensBelowUpAfterOpenAbove")
...
public class BBBarOpensAboveDownAfterOpenBelow extends ConditionBlock {
