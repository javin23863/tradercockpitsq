...
@BuildingBlock(name="OSMA is lower than 0", display="OSMA(@Chart@#FastEMA#, #SlowEMA#, #SignalPeriod#)[#Shift#] < 0", returnType = ReturnTypes.Boolean)
@SortOrder(400)
@OppositeBlock("OSMAHigherZero")
...
public class OSMALowerZero extends ConditionBlock {
