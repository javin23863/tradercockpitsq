...
@BuildingBlock(name="OSMA changes direction upwards", display="OSMA(@Chart@#FastEMA#, #SlowEMA#, #SignalPeriod#)[#Shift#] changes direction upwards", returnType = ReturnTypes.Boolean)
