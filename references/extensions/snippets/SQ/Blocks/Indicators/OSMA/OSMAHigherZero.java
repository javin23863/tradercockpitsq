...
@BuildingBlock(name="OSMA is higher than 0", display="OSMA(@Chart@#FastEMA#, #SlowEMA#, #SignalPeriod#)[#Shift#] > 0", returnType = ReturnTypes.Boolean)
@SortOrder(300)
@OppositeBlock("OSMALowerZero")
...
public class OSMAHigherZero extends ConditionBlock {
