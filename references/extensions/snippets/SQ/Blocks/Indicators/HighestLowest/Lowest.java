...
@BuildingBlock(name="Lowest", display="Lowest(@Chart@#Period#)[#Shift#]", returnType = ReturnTypes.Price, mainIndicator="LowestIndex")  
...
public class Lowest extends IndicatorBlock {
	...
	@Output(name = "Lowest", color = Colors.Green)
	...
	protected void OnBarUpdate() throws TradingException {
		...
		Value.set(0, lowestCalculator.getLowestValue());
	}
