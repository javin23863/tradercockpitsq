...
@BuildingBlock(name="Bar opens below Lowest after opened above", display="Bar opens below Lowest(@Chart@#Period#)[#Shift#] after opened above", returnType = ReturnTypes.Boolean, mainIndicator="Lowest")
