...
@BuildingBlock(name="LinReg is falling", display="LinReg(@Chart@#Period#)[#Shift#] is falling", returnType = ReturnTypes.Boolean, mainIndicator="LinearRegression")
@Help("Is triggered if LinReg is falling")
@OppositeBlock("LinRegRising")
@SortOrder(200)
...
public class LinRegFalling extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		LinearRegression indicator = Strategy.Indicators.LinearRegression(Input, Period);
