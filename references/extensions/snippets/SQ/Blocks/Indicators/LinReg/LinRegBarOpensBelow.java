...
@BuildingBlock(name="Bar opens below LinReg", display="Bar opens below LinReg(@Chart@#Period#)[#Shift#]", returnType = ReturnTypes.Boolean, mainIndicator="LinearRegression")
@OppositeBlock("LinRegBarOpensAbove")
...
public class LinRegBarOpensBelow extends ConditionBlock {
