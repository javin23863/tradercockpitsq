...
@BuildingBlock(name="Bar opens above LinReg after opened below", display="Bar opens above LinReg(@Chart@#Period#)[#Shift#] after opened below", returnType = ReturnTypes.Boolean, mainIndicator="LinearRegression")
@OppositeBlock("LinRegBarOpensBelowAfterOpenAbove")
...
public class LinRegBarOpensAboveAfterOpenBelow extends ConditionBlock {
