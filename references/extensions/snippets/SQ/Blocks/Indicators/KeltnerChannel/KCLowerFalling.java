...
@BuildingBlock(name="(KC) Lower band is falling", display="Keltner Channel(@Chart@#Period#, #Deviation#).Lower[#Shift#] is falling", returnType = ReturnTypes.Boolean)
...
public class KCLowerFalling extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double value2 = Strategy.Indicators.KeltnerChannel(Input, Period, Deviation).Lower.getRounded(Shift);
