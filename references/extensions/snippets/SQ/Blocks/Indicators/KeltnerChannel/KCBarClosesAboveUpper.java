...
@BuildingBlock(name="(KC) Bar closes above Upper band", display="Bar closes above Keltner Channel(@Chart@#Period#, #Deviation#).Upper[#Shift#]", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Bar closes above KC Upper band")
@OppositeBlock("KCBarClosesBelowLower")
...
public class KCBarClosesAboveUpper extends ConditionBlock {
