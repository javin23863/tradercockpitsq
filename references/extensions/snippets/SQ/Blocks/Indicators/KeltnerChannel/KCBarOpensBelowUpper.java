...
@BuildingBlock(name="(KC) Bar opens below Upper band", display="Bar opens below Keltner Channel(@Chart@#Period#, #Deviation#).Upper[#Shift#]", returnType = ReturnTypes.Boolean)
