...
@BuildingBlock(name="(KC) Bar closes above Lower band", display="Bar closes above Keltner Channel(@Chart@#Period#, #Deviation#).Lower[#Shift#]", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Bar closes above KC Lower band")
@OppositeBlock("KCBarClosesBelowUpper")
...
public class KCBarClosesAboveLower extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		double value1 = Strategy.Indicators.KeltnerChannel(Input, Period, Deviation).Lower.getRounded(Shift);
