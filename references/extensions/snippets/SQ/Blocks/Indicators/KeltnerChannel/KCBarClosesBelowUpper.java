...
@BuildingBlock(name="(KC) Bar closes below Upper band", display="Bar closes below Keltner Channel(@Chart@#Period#, #Deviation#).Upper[#Shift#]", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Bar closes below KC Upper band")
@OppositeBlock("KCBarClosesAboveLower")
...
public class KCBarClosesBelowUpper extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		double value1 = Strategy.Indicators.KeltnerChannel(Input, Period, Deviation).Upper.getRounded(Shift);
		return (Input.Close(Shift) < value1);
	}
