...
@BuildingBlock(name="(KC) Bar opens below Lower band after opened above", display="Bar opens below Keltner Channel(@Chart@#Period#, #Deviation#).Lower[#Shift#] after opened above", returnType = ReturnTypes.Boolean)
