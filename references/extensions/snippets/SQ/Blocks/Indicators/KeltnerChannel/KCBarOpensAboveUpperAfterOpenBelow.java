...
@BuildingBlock(name="(KC) Bar opens above Upper band after opened below", display="Bar opens above Keltner Channel(@Chart@#Period#, #Deviation#).Upper[#Shift#] after opened below", returnType = ReturnTypes.Boolean)
