...
@BuildingBlock(name="StdDev is rising", display="StdDev(@Chart@#Period#)[#Shift#] is rising", returnType = ReturnTypes.Boolean)
@Help("Is triggered if StdDev is rising")
@OppositeBlock("StdDevRising")
@SortOrder(100)
...
public class StdDevRising extends ConditionBlock {
