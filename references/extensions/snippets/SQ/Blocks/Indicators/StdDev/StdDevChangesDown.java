...
@BuildingBlock(name="StdDev changes direction downwards", display="StdDev(@Chart@#Period#)[#Shift#] changes direction downwards", returnType = ReturnTypes.Boolean)
@Help("Is triggered if StdDev changes direction downwards")
@OppositeBlock("StdDevChangesDown")
...
public class StdDevChangesDown extends ConditionBlock {
