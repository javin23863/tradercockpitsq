...
@BuildingBlock(name="StdDev changes direction upwards", display="StdDev(@Chart@#Period#)[#Shift#] changes direction upwards", returnType = ReturnTypes.Boolean)
@Help("Is triggered if StdDev changes direction upwards")
@OppositeBlock("StdDevChangesUp")
...
public class StdDevChangesUp extends ConditionBlock {
