...
@BuildingBlock(name="StdDev is higher than Level", display="StdDev(@Chart@#Period#)[#Shift#] > #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock("StdDevHigher")
...
public class StdDevHigher extends ConditionBlock {
	...
	@Parameter(defaultValue="0.01", minValue=0.0001, maxValue=3, step=0.01, builderMinValue=0.0001, builderMaxValue=1, builderStep=0.00025)
	public double Level;
