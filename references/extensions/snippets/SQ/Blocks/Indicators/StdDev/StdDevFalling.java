...
@BuildingBlock(name="StdDev is falling", display="StdDev(@Chart@#Period#)[#Shift#] is falling", returnType = ReturnTypes.Boolean)
@Help("Is triggered if StdDev is falling")
@OppositeBlock("StdDevFalling")
...
public class StdDevFalling extends ConditionBlock {
