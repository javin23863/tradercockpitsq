...
@BuildingBlock(name="MACD Main line changes direction upwards", display="MACD(@Chart@#Fast#, #Slow#, #Smooth#).Main[#Shift#] changes direction upwards", returnType = ReturnTypes.Boolean)
@Help("Is triggered if MACD Main changes direction upwards")
@SortOrder(200)
@OppositeBlock("MACDMainChangesDown")
...
public class MACDMainChangesUp extends ConditionBlock {
