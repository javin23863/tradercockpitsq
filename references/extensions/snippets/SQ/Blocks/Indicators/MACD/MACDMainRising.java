...
@BuildingBlock(name="MACD Main line is rising", display="MACD(@Chart@#Fast#, #Slow#, #Smooth#).Main[#Shift#] is rising", returnType = ReturnTypes.Boolean)
@Help("Is triggered if MACD Main is rising")
@SortOrder(1000)
@CategoryOrder(1500)
@OppositeBlock("MACDMainFalling")
...
public class MACDMainRising extends ConditionBlock {
