...
@BuildingBlock(name="MACD Main line is higher than Level", display="MACD(@Chart@#Fast#, #Slow#, #Smooth#).Main[#Shift#] > #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(1100)
@OppositeBlock(value="MACDMainLower", oscillator=true, middleValue=0, field="Level")
...
public class MACDMainHigher extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double value1 = indicator.Main.getRounded(Shift);
