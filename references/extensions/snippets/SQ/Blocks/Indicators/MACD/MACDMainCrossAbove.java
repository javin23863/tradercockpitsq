...
@BuildingBlock(name="MACD Main line crosses above Level", display="MACD(@Chart@#Fast#, #Slow#, #Smooth#).Main[#Shift#] crosses above #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(300)
@OppositeBlock(value="MACDMainCrossBelow", oscillator=true, middleValue=0, field="Level")
