...
@BuildingBlock(name="MACD Main line is higher than Signal", display="MACD(@Chart@#Fast#, #Slow#, #Smooth#).Main[#Shift#] > MACD.Signal", returnType = ReturnTypes.Boolean)
@SortOrder(1300)
@OppositeBlock("MACDMainLowerSignal")
...
public class MACDMainHigherSignal extends ConditionBlock {
