...
@BuildingBlock(name="MACD Main line crosses below Level", display="MACD(@Chart@#Fast#, #Slow#, #Smooth#).Main[#Shift#] crosses below #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(400)
@OppositeBlock(value="MACDMainCrossAbove", oscillator=true, middleValue=0, field="Level")
...
public class MACDMainCrossBelow extends ConditionBlock {
	...
	@Parameter(defaultValue="0", minValue=-5000, maxValue=5000, step=0.01, builderMinValue=-5, builderMaxValue=5, builderStep=0.001)
	public double Level;
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double value1 = indicator.Main.getRounded(Shift + 1);
		double value2 = indicator.Main.getRounded(Shift);
