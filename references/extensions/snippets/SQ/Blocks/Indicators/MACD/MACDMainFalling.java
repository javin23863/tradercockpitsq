...
@BuildingBlock(name="MACD Main line is falling", display="MACD(@Chart@#Fast#, #Slow#, #Smooth#).Main[#Shift#] is falling", returnType = ReturnTypes.Boolean)
@Help("Is triggered if MACD Main is falling")
@SortOrder(900)
@OppositeBlock("MACDMainRising")
...
public class MACDMainFalling extends ConditionBlock {
