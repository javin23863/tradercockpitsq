...
@BuildingBlock(name="MACD Main line crosses above Signal", display="MACD(@Chart@#Fast#, #Slow#, #Smooth#).Main[#Shift#] crosses above MACD.Signal", returnType = ReturnTypes.Boolean)
@SortOrder(500)
@OppositeBlock("MACDMainCrossBelowSignal")
...
public class MACDMainCrossAboveSignal extends ConditionBlock {
