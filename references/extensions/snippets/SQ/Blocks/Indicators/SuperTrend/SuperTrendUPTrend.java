...
@BuildingBlock(name="(STU) SuperTrend UP Trend", display="SuperTrend(@Chart@#Mode#,#ATRPeriod#,#ATRMult#)[#Shift#] is rising", returnType = ReturnTypes.Boolean)
@Help("Is triggered if SuperTrend is rising")
@OppositeBlock("SuperTrendDownTrend")
...
public class SuperTrendUPTrend extends ConditionBlock {
