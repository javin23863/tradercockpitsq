...
@BuildingBlock(name="ATR crosses below Level", display="ATR(@Chart@#Period#)[#Shift#] crosses below #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock("ATRCrossDown")
@SortOrder(600)
...
public class ATRCrossDown extends ConditionBlock {
	...
	@Parameter(defaultValue="0", minValue=-5000, maxValue=5000, step=0.001, builderMinValue=0, builderMaxValue=3, builderStep=0.001)
	public double Level;
