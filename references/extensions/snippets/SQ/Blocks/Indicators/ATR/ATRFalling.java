...
@BuildingBlock(name="ATR is falling", display="ATR(@Chart@#Period#)[#Shift#] is falling", returnType = ReturnTypes.Boolean)
@Help("Is triggered if ATR is falling")
@OppositeBlock("ATRFalling")
@SortOrder(200)
...
public class ATRFalling extends ConditionBlock {
