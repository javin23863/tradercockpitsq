...
@BuildingBlock(name="(RCD) Fast Reflex Crosses Down Slow Reflex", display="Fast Reflex(@Chart@#FastPeriod#)[#Shift#] Crosses Down Slow Reflex(#SlowPeriod#)", returnType = ReturnTypes.Boolean)
@Help("Is triggered if fast Reflex crosses Slow Reflex Down")
@MT5ExtendedTemplate
@OppositeBlock("FastReflexCrossUPSlowReflex")
...
public class FastReflexCrossDownSlowReflex extends ConditionBlock {
