...
@BuildingBlock(name="RSI is higher than Level", display="RSI(@Chart@#Period#)[#Shift#] > #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(300)
@OppositeBlock(value="RSILower", oscillator=true, middleValue=50, field="Level")
...
public class RSIHigher extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double value1 = indicator.Value.getRounded(Shift);
