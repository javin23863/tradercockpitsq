...
@BuildingBlock(name="RSI is lower than Level", display="RSI(@Chart@#Period#)[#Shift#] < #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(400)
@OppositeBlock(value="RSIHigher", oscillator=true, middleValue=50, field="Level")
...
public class RSILower extends ConditionBlock {
