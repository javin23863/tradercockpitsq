...
@BuildingBlock(name="RSI crosses below Level", display="RSI(@Chart@#Period#)[#Shift#] crosses below #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(600)
@OppositeBlock(value="RSICrossUp", oscillator=true, middleValue=50, field="Level")
...
public class RSICrossDown extends ConditionBlock {
