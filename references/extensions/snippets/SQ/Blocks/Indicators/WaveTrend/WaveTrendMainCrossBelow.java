...
@BuildingBlock(name="WaveTrend Main line crosses below Level", display="WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] crosses below #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="WaveTrendMainCrossAbove", oscillator=true, middleValue=0, field="Level")
@SortOrder(400)
...
public class WaveTrendMainCrossBelow extends ConditionBlock {
