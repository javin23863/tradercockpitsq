...
@BuildingBlock(name="WaveTrend Main line is higher than Signal", display="WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] > WaveTrend.Signal", returnType = ReturnTypes.Boolean)
@SortOrder(1300)
