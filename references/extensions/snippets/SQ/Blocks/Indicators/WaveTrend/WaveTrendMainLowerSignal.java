...
@BuildingBlock(name="WaveTrend Main line is lower than Signal", display="WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] < WaveTrend.Signal", returnType = ReturnTypes.Boolean)
@SortOrder(1400)
@ForEngine("MT4,MT5,TS,MC")
@OppositeBlock("WaveTrendMainHigherSignal")
...
public class WaveTrendMainLowerSignal extends ConditionBlock {
