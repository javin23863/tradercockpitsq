...
@BuildingBlock(name="WaveTrend Main line changes direction upwards", display="WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] changes direction upwards", returnType = ReturnTypes.Boolean)
