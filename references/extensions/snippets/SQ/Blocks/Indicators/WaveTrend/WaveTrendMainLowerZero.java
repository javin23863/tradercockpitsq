...
@BuildingBlock(name="WaveTrend Main line is lower than 0", display="WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] < 0", returnType = ReturnTypes.Boolean)
@SortOrder(1600)
