...
@BuildingBlock(name="WaveTrend Main line is rising", display="WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] is rising", returnType = ReturnTypes.Boolean)
