...
@BuildingBlock(name="WaveTrend Signal line is rising", display="WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Signal[#Shift#] is rising", returnType = ReturnTypes.Boolean)
@Help("Is triggered if WaveTrend Signal is rising")
@SortOrder(1800)
@ForEngine("MT4,MT5,TS,MC")
@OppositeBlock("WaveTrendSignalFalling")
...
public class WaveTrendSignalRising extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double value1 = indicator.WT2.getRounded(Shift + 1);
		double value2 = indicator.WT2.getRounded(Shift);
