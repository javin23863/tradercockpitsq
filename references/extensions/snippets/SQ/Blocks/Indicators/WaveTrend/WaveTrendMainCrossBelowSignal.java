...
@BuildingBlock(name="WaveTrend Main line crosses below Signal", display="WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] crosses below WaveTrend.Signal", returnType = ReturnTypes.Boolean)
@OppositeBlock("WaveTrendMainCrossAboveSignal")
@SortOrder(600)
...
public class WaveTrendMainCrossBelowSignal extends ConditionBlock {
