...
@BuildingBlock(name="Momentum crosses above Level", display="Momentum(@Chart@#Period#)[#Shift#] crosses above #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(500)
@OppositeBlock(value="MomCrossDown", oscillator=true, middleValue=100, field="Level")
...
public class MomCrossUp extends ConditionBlock {
	...
	@Parameter(defaultValue="0", minValue=0, maxValue=200, step=0.01, builderMinValue=90, builderMaxValue=110, builderStep=0.1)
	public double Level;
