...
@BuildingBlock(name="Momentum is lower than Level", display="Momentum(@Chart@#Period#)[#Shift#] < #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(400)
@OppositeBlock(value="MomHigher", oscillator=true, middleValue=100, field="Level")
