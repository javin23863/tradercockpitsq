...
@BuildingBlock(name="Momentum changes direction downwards", display="Momentum(@Chart@#Period#)[#Shift#] changes direction downwards", returnType = ReturnTypes.Boolean)
@OppositeBlock("MomChangesUp")
...
public class MomChangesDown extends ConditionBlock {
