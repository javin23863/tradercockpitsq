...
@BuildingBlock(name="(WO) Weekly Open", returnType=ReturnTypes.Price, display="OpenW[@Chart@#Shift#]")
@SortOrder(500)
public class OpenW extends ValueBlock {
	...
	public double OnBlockEvaluate(int relativeShift) throws TradingException {
		...
		if(Engines.isTradestationEngine(Strategy.getEngine())) {
			...
			return Chart.OpenW(Shift + weeksOffset);
		}
		else {
			return Chart.OpenW(Shift + relativeShift);
		}
	}
