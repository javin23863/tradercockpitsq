...
@BuildingBlock(name="(HA H) Heiken Ashi High", returnType=ReturnTypes.Price, display="Heiken Ashi High[@Chart@#Shift#]")
@SortOrder(2200)
...
public class HeikenAshiHigh extends ValueBlock {
	...
	public double OnBlockEvaluate(int relativeShift) throws TradingException {
		return Math.max(Chart.High(relativeShift + Shift), 
				Math.max(Strategy.Indicators.HeikenAshi(Chart).HAOpen.getRounded(relativeShift + Shift), 
