...
@BuildingBlock(name="(SO) Session Open", returnType=ReturnTypes.Price, display="SessionOpen(@Chart@#StartHours#:#StartMinutes#)[#Shift#]")
...
public class SessionOpen extends ValueBlock {
	...
	protected void OnInit() throws BlockDefinitionException {
		sessionCalculator = new SessionOHLCCalculator(SessionOHLCCalculator.OPEN, StartHours, StartMinutes, StartHours, StartMinutes, Shift, Chart);
	}
