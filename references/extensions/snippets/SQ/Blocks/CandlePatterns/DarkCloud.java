...
@BuildingBlock(name="DarkCloud pattern", display="DarkCloud pattern(@Chart@) before #Shift# bars", returnType = ReturnTypes.Boolean)
...
public class DarkCloud extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
    	...
    	double OC = SQUtils.round(O-C, digits);
    	double OC_HL = HL != 0 ? SQUtils.round(OC/HL, 6) : 0;
