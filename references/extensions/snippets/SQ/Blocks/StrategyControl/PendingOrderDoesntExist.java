...
@BuildingBlock(name="Pending order doesn't exist", display="Pending order(#Symbol#, #MagicNumber#, #Direction#, \"#Comment#\") doesn't exist", returnType = ReturnTypes.Boolean)
@Help("Is triggered when there doesn't exist specified pending order")
@SortOrder(500)
@IgnoreInBuilder
@ForEngine("*,-MC,-TS,-SP,-SA")
public class PendingOrderDoesntExist extends ConditionBlock {
