...
@BuildingBlock(name="(=) Equals", display="#Left# = #Right#", returnType = ReturnTypes.Boolean)
@OppositeBlock("NotEquals")
@SortOrder(500)
public class Equals extends LeftRightComparisonBlockAbstract {
