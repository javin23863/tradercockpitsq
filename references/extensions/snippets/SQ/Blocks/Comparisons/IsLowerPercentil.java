...
@BuildingBlock(name="(< % Rank) Is Lower or Equal Percent Rank", display="#Indicator# is lower or equal than #Percentile# % of the values over #Bars# bars in the past" , returnType = ReturnTypes.Boolean)
