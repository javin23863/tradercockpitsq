...
public class WinLossCountByWeekdayChart extends TradeAnalysisChart {

	public WinLossCountByWeekdayChart() {
		this.name = L.tsq("Wins/Losses by weekday");
	}
	...
	public AbstractChart draw(OrdersList orders, byte plType, byte tradePeriod) {
		...
		int[][] days = computeData(orders, plType, tradePeriod);
