...
/**
 * The Class ValueBlock.
 */
abstract public class ValueBlock extends StandardBlock {
	 ...
	 */
	abstract public double OnBlockEvaluate(int relativeShift) throws TradingException;
	...
	public double evaluateBlock(int relativeShift) throws TradingException {
		return this.OnBlockEvaluate(relativeShift);
	}
