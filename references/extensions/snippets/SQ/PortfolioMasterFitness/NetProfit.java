...
public class NetProfit extends PortfolioMasterFitness {
	...
	public NetProfit() {
		super(L.tsq("Net Profit (Return)"), ValueTypes.Maximize, 0, -10000, 10000);
	}
	...
	public double compute(ResultsGroup result, byte sampleType) throws Exception {
		return result.portfolio().stats(Directions.Both, PlTypes.Money, sampleType).getDouble(StatsKey.NET_PROFIT);
	}
