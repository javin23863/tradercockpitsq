...
public class ReturnDD extends PortfolioMasterFitness {
	...
	public ReturnDD() {
		super(L.tsq("Return / Drawdown ratio"), ValueTypes.Maximize, 0, -20, 20);
	}
	...
	public double compute(ResultsGroup result, byte sampleType) throws Exception {
		return result.portfolio().stats(Directions.Both, PlTypes.Money, sampleType).getDouble(StatsKey.RETURN_DD_RATIO);
	}
	...
	public String print(double value) {	
		return PlTypes.printPL(value, PlTypes.Money);
	}
}
