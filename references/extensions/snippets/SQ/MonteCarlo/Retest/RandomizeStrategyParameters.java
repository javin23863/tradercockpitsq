...
public class RandomizeStrategyParameters extends MonteCarloRetest {
	...
	public void modifySettings(IRandomGenerator rng, SettingsMap settings) throws Exception {
		...
		paramTypes.set(ParametrizationTypes.ParamTypeConstant, true);
		...
		paramTypes.set(ParametrizationTypes.ParamTypeTradingOptions, true);		
	...
	public RandomizeStrategyParameters getClone() throws Exception {
		RandomizeStrategyParameters mc = new RandomizeStrategyParameters();
