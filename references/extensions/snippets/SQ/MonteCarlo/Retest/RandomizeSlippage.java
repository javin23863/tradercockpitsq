...
public class RandomizeSlippage extends MonteCarloRetest {
	...
	@Parameter(name="Min", defaultValue="0", minValue=0, maxValue=10000, step=0.1)
	public double Min;
	...
	public void modifySettings(IRandomGenerator rng, SettingsMap settings) throws Exception {
		...
		double slippage = Min + rng.nextInt(steps) * 0.1;
	...
	public RandomizeSlippage getClone() throws Exception {
		RandomizeSlippage mc = new RandomizeSlippage();
		mc.Min = this.Min;
		mc.Max = this.Max;
