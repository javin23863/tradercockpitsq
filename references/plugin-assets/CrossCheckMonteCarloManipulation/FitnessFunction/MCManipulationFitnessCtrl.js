angular.module('app').controller('MCManipulationFitnessCtrl', function ($rootScope, $scope, MCManipulationFitnessService, RankingService, AppService, $q) {
    console.log("MCManipulationFitness controller initialized");
    ...
    MCManipulationFitnessService.getLevels(function(data) {
        $scope.confidenceLevels = data.levels;   
    });

    MCManipulationFitnessService.list(function(data) {
