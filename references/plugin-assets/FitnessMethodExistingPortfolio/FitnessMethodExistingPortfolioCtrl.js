angular.module('app.fitnessExistingPortfolio').controller('FitnessMethodExistingPortfolioCtrl', function ($rootScope, $scope, $timeout, $q, $interval, FitnessMethodExistingPortfolioService, UniqueIdGenerator, L, AppService, SQEvents, SQConstants) {
    console.log("FitnessMethodExistingPortfolioCtrl controller initialized");
    ...
    FitnessMethodExistingPortfolioService.list(function(data) {
