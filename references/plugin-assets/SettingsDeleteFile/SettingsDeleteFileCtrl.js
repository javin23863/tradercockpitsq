angular.module('app.settings').controller('SettingsDeleteFileCtrl', function ($rootScope, $scope, $timeout, $q, $element, SettingsDeleteFileService, AppService, SQConstants, SQEvents, L) {
    console.log("SettingsDeleteFileCtrl controller initialized");

    function init() {
        loaded = false;

        SettingsDeleteFileService.loadSettings();
    ...
    var listenerId = "SettingsDeleteFileCtrl";
