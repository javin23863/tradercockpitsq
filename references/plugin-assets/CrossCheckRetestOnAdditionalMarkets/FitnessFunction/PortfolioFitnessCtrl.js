angular.module('app').controller('PortfolioFitnessCtrl', function ($rootScope, $scope, $timeout, $interval, $q, PortfolioFitnessService, UniqueIdGenerator, RankingService, AppService, L, SQConstants) {
    console.log("PortfolioFitness controller initialized");
    ...
    PortfolioFitnessService.list(function(data) {
