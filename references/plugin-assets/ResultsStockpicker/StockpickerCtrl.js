angular.module('app.resultstabs.stockpicker').controller('StockpickerCtrl', function ($scope, $timeout, $q, StockpickerService, SQResultsData, $element, SkinService, SQEvents, L) {
    console.log("Stockpicker controller initialized");
    ...
    function initEditor() {
        ...
        require(['vs/editor/editor.main'], function () {
            $timeout(function () {
                ...
                var targetElement = document.getElementById('stockpicker-editor');
    ...
    function fetchData(params) {
        ...
        StockpickerService.print(params, function (result) {
    ...
    $scope.$on('$destroy', function () {
        ...
        if (window.parent && window.parent.removeListener) {
            window.parent.removeListener("StockpickerCtrlSkin");
        }
    ...
    if (window.parent && window.parent.addListener) {
        window.parent.addListener("StockpickerCtrlSkin", [SQEvents.get("SKIN_CHANGED")], onSkinChanged);
    }

    if (isAlgoWizard()) {
        SQEvents.addListener("StockpickerCtrlSkin", [
