...
private double sqMMFixedAmount(String symbol, OrderCommand orderType, double price, double sl, double RiskedMoney, int decimals, double LotsIfNoMM, double MaximumLots) throws JFException {
   print("Computing Money Management for order - Fixed amount");
   ...
   if(RiskedMoney <= 0 ) {
      print("Computing Money Management - Incorrect RiskedMoney value, it must be above 0");
      return 0;
   }
   ...
   print("Money to risk: ", RiskedMoney, ", Max Trade drawdown: ", oneLotSLDrawdown, ", Point value: ", PointValue);
