...
double sqMMCryptoSizeByPrice(String symbol, OrderCommand orderType, double price, boolean UseAccountBalance, double MaximumLots, int mmDecimals) throws JFException {
   ...
   if(UseAccountBalance) {
	 ...
	 LotSize = roundDown(LotSize, mmDecimals);
