...
(sqGetValue(<@printInput block true />, PRICE_OPEN, <@printShift block "1" />) < sqKeltnerChannel(<@printInput block />, <@printParam block "#Period#" />, <@printParam block "#Deviation#" />, 1, <@printShift block "1" />)
&&
