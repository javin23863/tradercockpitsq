...
/**
 * The Class ConditionBlock.
 */
abstract public class ConditionBlock extends StandardBlock {
	 ...
	 */
	abstract public boolean OnBlockEvaluate() throws TradingException;
	...
	public double evaluateBlock() throws TradingException {
		return (this.OnBlockEvaluate() ? IBlock.True : IBlock.False);
	}
