...
/**
 * The Class ComparisonBlock.
 */
abstract public class ComparisonBlock extends StandardBlock {
	...
	/**
	 * On evaluate comparison.
	 *
	 * @return true, if successful
	 * @throws TradingException the trading exception
	 */
	abstract public boolean OnEvaluateComparison() throws TradingException;
	...
	public double evaluateBlock(int relativeShift) throws TradingException {
		return (this.OnEvaluateComparison() ? IBlock.True : IBlock.False);
	}
