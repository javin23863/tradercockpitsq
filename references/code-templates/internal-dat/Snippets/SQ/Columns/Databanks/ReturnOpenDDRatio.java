...
public class ReturnOpenDDRatio extends DatabankColumn {
	...
	public ReturnOpenDDRatio() {
		super(L.tsq("Ret/OpenDD Ratio"), DatabankColumn.Decimal2, ValueTypes.Maximize, 0, -20, 20);

		setDependencies("NetProfit", "OpenDrawdown", "NumberOfTrades");
		setTooltip(L.tsq("Return / Open Drawdown Ratio"));
	}
	...
	public double compute(SQStats stats, StatsTypeCombination combination, OrdersList ordersList, SettingsMap settings, SQStats statsLong, SQStats statsShort) throws Exception {
		...
		double openDD = Math.abs(stats.getDouble("OpenDrawdown"));
		...
		return round2(safeDivide(netProfit, openDD));
	}	
}