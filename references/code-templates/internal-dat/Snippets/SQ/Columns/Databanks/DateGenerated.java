...
public class DateGenerated extends DatabankColumn {
	...
	public DateGenerated() {
		super("Date generated", DatabankColumn.Time, ValueTypes.Minimize, 0, 0, 10000);

		setTooltip(L.tsq("Date generated"));
		setWidth(150);
	...
	public double getNumericValue(ResultsGroup results, String resultKey, byte direction, byte plType, byte sampleType) throws Exception {
		return results.specialValues().getLong(SpecialValues.DateGenerated, -1);
	}
