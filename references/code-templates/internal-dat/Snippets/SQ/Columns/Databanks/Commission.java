...
public class Commission extends DatabankColumn {
    
	public Commission() {
		super(L.tsq("Commission/Swap ($)"), DatabankColumn.Decimal2PL, ValueTypes.Minimize, 0, 0, 5);
