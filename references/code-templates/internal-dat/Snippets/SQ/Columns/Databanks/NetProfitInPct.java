...
public class NetProfitInPct extends DatabankColumn {
    
	public NetProfitInPct() {
		super(L.tsq("Net profit in %"), DatabankColumn.Decimal2Pct, ValueTypes.Maximize, 0, -10000, 10000);
