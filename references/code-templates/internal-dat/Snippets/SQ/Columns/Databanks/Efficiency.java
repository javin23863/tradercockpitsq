...
public class Efficiency extends DatabankColumn {
	...
	public Efficiency() {
		...
		setTooltip("Efficiency of trading strategy. Net profit divided by Gross profit");

		setDependencies("GrossProfit", "GrossLoss");
	}
	...
	public double compute(SQStats stats, StatsTypeCombination combination, OrdersList ordersList, SettingsMap settings, SQStats statsLong, SQStats statsShort) throws Exception {
		...
		double sumProfits = stats.getDouble("GrossProfit");
		double sumLosses = stats.getDouble("GrossLoss");

		return SQUtils.round2(SQUtils.safeDivide(sumProfits - sumLosses, sumProfits) * 100);
