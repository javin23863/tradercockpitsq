...
/**
 * Degrees of freedom are computed internally. The formula is: Number of trades (IS) - Complexity
 */
public class DegreesOfFreedom extends DatabankColumn {
    
	public DegreesOfFreedom() {
		super(L.tsq("Degrees of freedom"), DatabankColumn.Integer, ValueTypes.Minimize, 0, 0, 100);
		
		setDependencies("NumberOfTrades", "Complexity");
	}
	...
	public double compute(SQStats stats, StatsTypeCombination combination, OrdersList ordersList, SettingsMap settings, SQStats statsLong, SQStats statsShort) throws Exception {
		int complexity = stats.getInt("Complexity");
		int numberOfTrades = stats.getInt("NumberOfTrades");
		
		int degreesOfFreedom = numberOfTrades - complexity;
