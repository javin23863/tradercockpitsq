...
public class NumberOfTrades extends DatabankColumn {
    
	public NumberOfTrades() {
		super(L.tsq("# of trades"), DatabankColumn.Integer, ValueTypes.Aproximate, 0, 0, 100);

		setWidth(70);
		
		setTooltip(L.tsq("Number of trades"));
