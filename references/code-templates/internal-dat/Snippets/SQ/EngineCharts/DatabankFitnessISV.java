...
public class DatabankFitnessISV extends EngineChart {
	...
	public DatabankFitnessISV() {
		super(L.tsq("Databank Fitness - IS Validation"), TYPE_PROJECT_BASED);
	...
	private void addValueFromDatabank(Databank databank) {
    	...
    	bestSeries.addValue(time, data.bestFitnessISV);
    	topAvgSeries.addValue(time, data.topAvgFitnessISV);
    	avgSeries.addValue(time, data.avgFitnessISV);
	}
