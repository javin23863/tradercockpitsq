...
public class DatabankFitnessIS extends EngineChart {
	...
	public DatabankFitnessIS() {
		super(L.tsq("Databank Fitness - IS"), TYPE_PROJECT_BASED);
	...
	private void addValueFromDatabank(Databank databank) {
    	...
    	bestSeries.addValue(time, data.bestFitnessIS);
    	topAvgSeries.addValue(time, data.topAvgFitnessIS);
    	avgSeries.addValue(time, data.avgFitnessIS);
	}
