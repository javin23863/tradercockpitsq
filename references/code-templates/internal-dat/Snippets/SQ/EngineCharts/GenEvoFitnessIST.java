...
public class GenEvoFitnessIST extends EngineChart {
	...
	public GenEvoFitnessIST() {
		super(L.tsq("Island #1 - Fitness IS Training"), TYPE_PROJECT_BASED);
		...
		if(geneticInfo.isGeneticBuild()) {
			...
			if(islandsEvoData != null && islandsEvoData.length > 0) {
				...
				if(generationData != null) {
					bestFitness = generationData.bestFitnessIST;
					best5Fitness = generationData.topAvgFitnessIST;
					avgFitness = generationData.avgFitnessIST;
				}
			}
		}
