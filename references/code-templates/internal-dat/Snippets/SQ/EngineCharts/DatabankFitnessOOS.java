...
public class DatabankFitnessOOS extends EngineChart {
	...
	public DatabankFitnessOOS() {
		super(L.tsq("Databank Fitness - OOS"), TYPE_PROJECT_BASED);
	...
	private void addValueFromDatabank(Databank databank) {
    	...
    	bestSeries.addValue(time, data.bestFitnessOOS);
    	topAvgSeries.addValue(time, data.topAvgFitnessOOS);
    	avgSeries.addValue(time, data.avgFitnessOOS);
	}
