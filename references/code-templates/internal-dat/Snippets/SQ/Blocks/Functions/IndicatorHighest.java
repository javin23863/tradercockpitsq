...
@BuildingBlock(name="(IH) Indicator Highest Value", display="Indicator Highest(#NthValue#, #Period#, #Indicator#)", returnType = ReturnTypes.Number)
...
public class IndicatorHighest extends ValueBlock {
	...
	@Parameter(name="Nth highest value", defaultValue="0", minValue=0)
	...
	public double OnBlockEvaluate(int relativeShift) throws TradingException {
		...
		return(indicatorValues[MAX_VALUES-1-NthValue]);
	}
