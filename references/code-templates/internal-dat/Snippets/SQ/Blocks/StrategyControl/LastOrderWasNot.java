...
@BuildingBlock(display="Last order(#Symbol#, #MagicNumber#, \"#Comment#\") was not #Direction#", returnType = ReturnTypes.Boolean)
@Help("Returns true is direction of last order doesn't match the specified direction. Considers only executed orders, not pending orders that were closed.")
@SortOrder(700)
@IgnoreInBuilder
@ForEngine("*,-MC,-TS,-SP,-SA")
public class LastOrderWasNot extends ConditionBlock {
