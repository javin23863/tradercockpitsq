...
@BuildingBlock(name="(STR) Super Trend is in Range", display="SuperTrend(@Chart@#Mode#,#ATRPeriod#,#ATRMult#)[#Shift#] is in Range", returnType = ReturnTypes.Boolean)
@Help("Is triggered if SuperTrend is in range")
@OppositeBlock("SuperTrendInRange")
...
public class SuperTrendInRange extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double curSTValue = indicator.Value.getRounded(Shift,5);
		double prevSTValue = indicator.Value.getRounded(Shift+1,5);
