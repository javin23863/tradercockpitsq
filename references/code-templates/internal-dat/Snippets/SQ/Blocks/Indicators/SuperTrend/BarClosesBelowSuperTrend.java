...
@BuildingBlock(name="(BCAST) Bar closes below SuperTrend", display="Bar closes below SuperTrend(@Chart@#Mode#,#ATRPeriod#,#ATRMult#)[#Shift#]", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Bar closes below SuperTrend")
@OppositeBlock("BarClosesAboveSuperTrend")
...
public class BarClosesBelowSuperTrend extends ConditionBlock {
