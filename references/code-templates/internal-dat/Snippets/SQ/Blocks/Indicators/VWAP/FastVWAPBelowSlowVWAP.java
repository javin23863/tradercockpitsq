...
@BuildingBlock(name="(DVWAPD) Faster VWAP is below Slower VWAP", display="Faster VWAP(@Chart@#FastPeriod#)[#Shift#] is below Slower VWAP(@Chart@#SlowPeriod#)[#Shift#]", returnType = ReturnTypes.Boolean)
