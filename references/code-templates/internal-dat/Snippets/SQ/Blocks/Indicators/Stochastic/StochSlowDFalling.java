...
@BuildingBlock(name="Stochastic.Slow %D is falling", display="Stoch(@Chart@#KPeriod#, #DPeriod#, #Slowing#).Slow %D[#Shift#] is falling", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Stochastic is falling")
@SortOrder(200)
@OppositeBlock("StochSlowDRising")
...
public class StochSlowDFalling extends ConditionBlock {
