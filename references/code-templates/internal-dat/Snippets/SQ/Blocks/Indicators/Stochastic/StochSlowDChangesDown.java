...
@BuildingBlock(name="Stochastic.Slow %D changes direction downwards", display="Stoch(@Chart@#KPeriod#, #DPeriod#, #Slowing#).Slow %D[#Shift#] changes direction downwards", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Stochastic changes direction downwards")
@SortOrder(100)
@OppositeBlock("StochSlowDChangesUp")
...
public class StochSlowDChangesDown extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double value1 = indicator.SlowD.getRounded(Shift + 2);
		double value2 = indicator.SlowD.getRounded(Shift + 1);
		double value3 = indicator.SlowD.getRounded(Shift);
