...
@BuildingBlock(name="Stochastic.Slow %D is higher than Level", display="Stoch(@Chart@#KPeriod#, #DPeriod#, #Slowing#).Slow %D[#Shift#] > #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(300)
@OppositeBlock(value="StochSlowDLower", oscillator=true, middleValue=50, field="Level")
...
public class StochSlowDHigher extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double value1 = indicator.SlowD.getRounded(Shift);
