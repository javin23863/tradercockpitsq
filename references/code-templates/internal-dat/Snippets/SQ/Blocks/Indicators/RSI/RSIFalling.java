...
@BuildingBlock(name="RSI is falling", display="RSI(@Chart@#Period#)[#Shift#] is falling", returnType = ReturnTypes.Boolean)
@Help("Is triggered if RSI is falling")
@SortOrder(200)
@OppositeBlock("RSIRising")
...
public class RSIFalling extends ConditionBlock {
