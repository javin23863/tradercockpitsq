...
@BuildingBlock(name="(KC) Bar opens below Upper band after opened above", display="Bar opens below Keltner Channel(@Chart@#Period#, #Deviation#).Upper[#Shift#] after opened above", returnType = ReturnTypes.Boolean)
