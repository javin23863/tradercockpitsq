...
@BuildingBlock(name="(KC) Bar opens above Upper band", display="Bar opens above Keltner Channel(@Chart@#Period#, #Deviation#).Upper[#Shift#]", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Bar opens above KC Upper band")
@OppositeBlock("KCBarOpensBelowLower")
...
public class KCBarOpensAboveUpper extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		return (Input.Open(Shift) > value1);
	}
