...
@BuildingBlock(name="(KC) Bar closes below Lower band", display="Bar closes below Keltner Channel(@Chart@#Period#, #Deviation#).Lower[#Shift#]", returnType = ReturnTypes.Boolean)
