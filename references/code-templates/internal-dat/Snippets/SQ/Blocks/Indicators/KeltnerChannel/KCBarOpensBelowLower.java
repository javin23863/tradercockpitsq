...
@BuildingBlock(name="(KC) Bar opens below Lower band", display="Bar opens below Keltner Channel(@Chart@#Period#, #Deviation#).Lower[#Shift#]", returnType = ReturnTypes.Boolean)
