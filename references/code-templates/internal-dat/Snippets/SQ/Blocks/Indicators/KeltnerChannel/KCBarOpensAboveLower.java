...
@BuildingBlock(name="(KC) Bar opens above Lower band", display="Bar opens above Keltner Channel(@Chart@#Period#, #Deviation#).Lower[#Shift#]", returnType = ReturnTypes.Boolean)
