...
@BuildingBlock(name="DeMarker crosses below Level", display="DeMarker(@Chart@#Period#)[#Shift#] crosses below #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="DEMCrossUp", oscillator=true, middleValue=0.5, field="Level")
@SortOrder(600)
...
public class DEMCrossDown extends ConditionBlock {
	...
	@Parameter(defaultValue="0", minValue=0, maxValue=1, step=0.01)
	public double Level;
	...
	public boolean OnBlockEvaluate() throws TradingException {
		DeMarker indicator = Strategy.Indicators.DeMarker(Input, Period);
