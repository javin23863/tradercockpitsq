...
@BuildingBlock(name="Bar opens above Moving Average after opened below", display="Bar opens above #Type# Moving Average(@Chart@#Period#)[#Shift#] after opened below", returnType = ReturnTypes.Boolean)
...
public class MABarOpensAboveAfterOpenBelow extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		switch(Type){
			...
			default: Value = Strategy.Indicators.SMA(Chart.getSeries(ComputedFrom), Period).Value; break;
		}
