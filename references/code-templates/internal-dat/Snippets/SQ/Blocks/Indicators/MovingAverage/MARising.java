...
@BuildingBlock(name="Moving Average is rising", display="#Type# Moving Average(@Chart@#Period#)[#Shift#] is rising", returnType = ReturnTypes.Boolean)
@Help("Is triggered if MA is rising")
@CategoryOrder(500)
@OppositeBlock("MAFalling")
...
public class MARising extends ConditionBlock {
