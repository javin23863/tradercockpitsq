...
@BuildingBlock(name="(BB) Bar opens below Upper band", display="Bar opens below BB(@Chart@#Period#, #Deviation#).Upper[#Shift#]", returnType = ReturnTypes.Boolean)
@OppositeBlock("BBBarOpensAboveDown")
...
public class BBBarOpensBelowUp extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		return (Chart.Open(Shift) < value1);
	}
