...
@BuildingBlock(name="(BB) Lower band is rising", display="BB(@Chart@#Period#, #Deviation#).Lower[#Shift#] is rising", returnType = ReturnTypes.Boolean)
@Help("Is triggered if BB is rising")
@OppositeBlock("BBUpperFalling")
...
public class BBLowerRising extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double value1 = Strategy.Indicators.BollingerBands(Chart, Period, Deviation).Lower.getRounded(Shift+1);
		double value2 = Strategy.Indicators.BollingerBands(Chart, Period, Deviation).Lower.getRounded(Shift);
