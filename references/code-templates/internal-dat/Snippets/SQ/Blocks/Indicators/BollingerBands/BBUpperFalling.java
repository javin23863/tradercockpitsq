...
@BuildingBlock(name="(BB) Upper band is falling", display="BB(@Chart@#Period#, #Deviation#).Upper[#Shift#] is falling", returnType = ReturnTypes.Boolean)
@Help("Is triggered if BB is falling")
@OppositeBlock("BBLowerRising")
...
public class BBUpperFalling extends ConditionBlock {
