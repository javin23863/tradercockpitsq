...
@BuildingBlock(name="(BB) Bar opens below Lower band after opened above", display="Bar opens below BB(@Chart@#Period#, #Deviation#).Lower[#Shift#] after opened above", returnType = ReturnTypes.Boolean)
@OppositeBlock("BBBarOpensAboveUpAfterOpenBelow")
...
public class BBBarOpensBelowDownAfterOpenAbove extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		double value1 = Strategy.Indicators.BollingerBands(Chart.getSeries(ComputedFrom), Period, Deviation).Lower.getRounded(Shift+1);
