...
@BuildingBlock(name="(BB) Bar closes above Lower band", display="Bar closes above BB(@Chart@#Period#, #Deviation#).Lower[#Shift#]", returnType = ReturnTypes.Boolean)
@OppositeBlock("BBBarClosesBelowUp")
...
public class BBBarClosesAboveDown extends ConditionBlock {
