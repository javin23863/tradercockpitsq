...
@BuildingBlock(name="(BB) Lower band is falling", display="BB(@Chart@#Period#, #Deviation#).Lower[#Shift#] is falling", returnType = ReturnTypes.Boolean)
...
public class BBLowerFalling extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		// it is falling if current value (at Shift) is lower than previous one
