...
@BuildingBlock(name="(BB) Bar closes below Upper band", display="Bar closes below BB(@Chart@#Period#, #Deviation#).Upper[#Shift#]", returnType = ReturnTypes.Boolean)
@OppositeBlock("BBBarClosesAboveDown")
...
public class BBBarClosesBelowUp extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		double value1 = Strategy.Indicators.BollingerBands(Chart.getSeries(ComputedFrom), Period, Deviation).Upper.getRounded(Shift);
