...
@BuildingBlock(name="(BBR) BB Range", display="BB Range(@Chart@#Period#, #Deviation#)[#Shift#]", returnType=ReturnTypes.PriceRange)
...
public class BBRange extends IndicatorBlock {
	...
	@Output(name="BB Range", color=Colors.Green)
	...
	protected void OnBarUpdate() throws TradingException {
		stdDevCalculator.onBarUpdate(Chart.getSeries(ComputedFrom).get(Shift), getCurrentBar());
	
		Value.set(0, 2 * Deviation * stdDevCalculator.getValue());
	}
