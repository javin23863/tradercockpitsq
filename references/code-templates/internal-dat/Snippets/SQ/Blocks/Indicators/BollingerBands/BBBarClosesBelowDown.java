...
@BuildingBlock(name="(BB) Bar closes below Lower band", display="Bar closes below BB(@Chart@#Period#, #Deviation#).Lower[#Shift#]", returnType = ReturnTypes.Boolean)
@OppositeBlock("BBBarClosesAboveUp")
...
public class BBBarClosesBelowDown extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		double value1 = Strategy.Indicators.BollingerBands(Chart.getSeries(ComputedFrom), Period, Deviation).Lower.getRounded(Shift);
