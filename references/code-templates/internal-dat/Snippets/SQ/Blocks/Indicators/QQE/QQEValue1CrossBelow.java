...
@BuildingBlock(name="QQE Value1 line crosses below Level", display="QQE(@Chart@#RSIPeriod#).Value1[#Shift#] crosses below #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(600)
@OppositeBlock(value="QQEValue1CrossAbove", oscillator=true, middleValue=50, field="Level")
