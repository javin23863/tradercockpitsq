...
@BuildingBlock(name="QQE Value1 line changes direction upwards", display="QQE(@Chart@#RSIPeriod#).Value1[#Shift#] changes direction upwards", returnType = ReturnTypes.Boolean)
@Help("Is triggered if QQE Value1 changes direction upwards")
@SortOrder(700)
@OppositeBlock("QQEValue1ChangesDown")
@ParameterSet(set="RSIPeriod=14,sF=5,wF=4.236")
public class QQEValue1ChangesUp extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double value1 = indicator.Value1.getRounded(Shift + 2);
		double value2 = indicator.Value1.getRounded(Shift + 1);
		double value3 = indicator.Value1.getRounded(Shift);
