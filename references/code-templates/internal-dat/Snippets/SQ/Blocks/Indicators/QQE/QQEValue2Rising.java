...
@BuildingBlock(name="QQE Value2 line is rising", display="QQE(@Chart@#RSIPeriod#).Value2[#Shift#] is rising", returnType = ReturnTypes.Boolean)
@Help("Is triggered if QQE Value2 is rising")
@SortOrder(100)
@OppositeBlock("QQEValue2Falling")
@ParameterSet(set="RSIPeriod=14,sF=5,wF=4.236")
public class QQEValue2Rising extends ConditionBlock {
