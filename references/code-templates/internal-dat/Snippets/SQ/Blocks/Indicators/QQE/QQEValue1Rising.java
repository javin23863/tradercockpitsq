...
@BuildingBlock(name="QQE Value1 line is rising", display="QQE(@Chart@#RSIPeriod#).Value1[#Shift#] is rising", returnType = ReturnTypes.Boolean)
@Help("Is triggered if QQE Value1 is rising")
@SortOrder(100)
@CategoryOrder(1500)
@OppositeBlock("QQEValue1Falling")
@ParameterSet(set="RSIPeriod=14,sF=5,wF=4.236")
public class QQEValue1Rising extends ConditionBlock {
