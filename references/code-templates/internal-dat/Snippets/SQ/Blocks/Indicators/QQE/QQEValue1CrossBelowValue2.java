...
@BuildingBlock(name="QQE Value1 line crosses below Value2", display="QQE(@Chart@#RSIPeriod#).Value1[#Shift#] crosses below QQE.Value2", returnType = ReturnTypes.Boolean)
@SortOrder(600)
@OppositeBlock("QQEValue1CrossAboveValue2")
@ParameterSet(set="RSIPeriod=14,sF=5,wF=4.236")
public class QQEValue1CrossBelowValue2 extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double main1 = indicator.Value1.getRounded(Shift + 1);
		double main2 = indicator.Value1.getRounded(Shift);

		double signal1 = indicator.Value2.getRounded(Shift + 1);
		double signal2 = indicator.Value2.getRounded(Shift);
