...
@BuildingBlock(name="QQE Value1 line is lower than Value2", display="QQE(@Chart@#RSIPeriod#).Value1[#Shift#] < QQE.Value2", returnType = ReturnTypes.Boolean)
@SortOrder(400)
@OppositeBlock("QQEValue1HigherValue2")
@ParameterSet(set="RSIPeriod=14,sF=5,wF=4.236")
public class QQEValue1LowerValue2 extends ConditionBlock {
