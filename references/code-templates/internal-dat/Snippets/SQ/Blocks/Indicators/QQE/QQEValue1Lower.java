...
@BuildingBlock(name="QQE Value1 line is lower than Level", display="QQE(@Chart@#RSIPeriod#).Value1[#Shift#] < #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(400)
@OppositeBlock(value="QQEValue1Higher", oscillator=true, middleValue=50, field="Level")
@ParameterSet(set="RSIPeriod=14,sF=5,wF=4.236")
public class QQEValue1Lower extends ConditionBlock {
