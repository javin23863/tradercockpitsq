...
@BuildingBlock(name="QQE Value2 line is falling", display="QQE(@Chart@#RSIPeriod#).Value2[#Shift#] is falling", returnType = ReturnTypes.Boolean)
@Help("Is triggered if QQE Value2 is falling")
@SortOrder(200)
@OppositeBlock("QQEValue2Rising")
@ParameterSet(set="RSIPeriod=14,sF=5,wF=4.236")
public class QQEValue2Falling extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double value1 = indicator.Value2.getRounded(Shift + 1);
