...
@BuildingBlock(name="Bar opens below Highest after opened above", display="Bar opens below Highest(@Chart@#Period#)[#Shift#] after opened above", returnType = ReturnTypes.Boolean, mainIndicator="Highest")
