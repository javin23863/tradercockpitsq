...
@BuildingBlock(name="Smallest Range", display="SmallestRange(@Chart@#Period#)[#Shift#]", returnType = ReturnTypes.PriceRange)
...
public class SmallestRange extends IndicatorBlock {
	...
	protected void OnBarUpdate() throws TradingException {
		double smallestRange = 100000000;
