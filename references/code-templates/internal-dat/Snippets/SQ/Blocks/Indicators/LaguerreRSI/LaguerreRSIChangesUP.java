...
@BuildingBlock(name="(LRSICU) Laguerre RSI changes direction upwards", display="Laguerre RSI(@Chart@#Gamma#)[#Shift#] changes direction upwards", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Laguerre RSI changes direction upwards")
@OppositeBlock("LaguerreRSIChangesDown")
...
public class LaguerreRSIChangesUP extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double prev2 = indicator.LRSI.getRounded(Shift+2);

		
		return (curr > prev) &&(prev2 > prev);
	}
