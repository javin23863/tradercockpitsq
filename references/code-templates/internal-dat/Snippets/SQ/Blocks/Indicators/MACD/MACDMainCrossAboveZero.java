...
@BuildingBlock(name="MACD Main line crosses above 0", display="MACD(@Chart@#Fast#, #Slow#, #Smooth#).Main[#Shift#] crosses above 0", returnType = ReturnTypes.Boolean)
@SortOrder(700)
@OppositeBlock("MACDMainCrossBelowZero")
...
public class MACDMainCrossAboveZero extends ConditionBlock {
