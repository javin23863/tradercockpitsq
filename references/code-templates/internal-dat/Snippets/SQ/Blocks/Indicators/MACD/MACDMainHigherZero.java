...
@BuildingBlock(name="MACD Main line is higher than 0", display="MACD(@Chart@#Fast#, #Slow#, #Smooth#).Main[#Shift#] > 0", returnType = ReturnTypes.Boolean)
@SortOrder(1500)
@OppositeBlock("MACDMainLowerZero")
...
public class MACDMainHigherZero extends ConditionBlock {
