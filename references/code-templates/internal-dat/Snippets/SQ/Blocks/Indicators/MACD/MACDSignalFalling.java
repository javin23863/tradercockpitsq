...
@BuildingBlock(name="MACD Signal line is falling", display="MACD(@Chart@#Fast#, #Slow#, #Smooth#).Signal[#Shift#] is falling", returnType = ReturnTypes.Boolean)
@Help("Is triggered if MACD Signal is falling")
@SortOrder(1700)
@OppositeBlock("MACDSignalRising")
...
public class MACDSignalFalling extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double value1 = indicator.Signal.getRounded(Shift + 1);
		double value2 = indicator.Signal.getRounded(Shift);
