...
@BuildingBlock(name="MACD Main line is lower than 0", display="MACD(@Chart@#Fast#, #Slow#, #Smooth#).Main[#Shift#] < 0", returnType = ReturnTypes.Boolean)
@SortOrder(1600)
@OppositeBlock("MACDMainHigherZero")
...
public class MACDMainLowerZero extends ConditionBlock {
