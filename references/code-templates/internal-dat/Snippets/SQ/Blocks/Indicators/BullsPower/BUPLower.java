...
@BuildingBlock(name="Bulls Power is lower than Level", display="BullsPower(@Chart@#Period#)[#Shift#] < #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="BEPHigher", oscillator=true, middleValue=0, field="Level")
@SortOrder(400)
...
public class BUPLower extends ConditionBlock {
	...
	@Parameter(defaultValue="0", minValue=-5000, maxValue=5000, step=0.001, builderMinValue=-0.5, builderMaxValue=0.5, builderStep=0.01)
	public double Level;
