...
@BuildingBlock(name="Bulls Power crosses above Level", display="BullsPower(@Chart@#Period#)[#Shift#] crosses above #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="BEPCrossDown", oscillator=true, middleValue=0, field="Level")
@SortOrder(500)
...
public class BUPCrossUp extends ConditionBlock {
