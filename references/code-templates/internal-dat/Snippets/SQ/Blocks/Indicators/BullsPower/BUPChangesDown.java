...
@BuildingBlock(name="Bulls Power changes direction downwards", display="BullsPower(@Chart@#Period#)[#Shift#] changes direction downwards", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Bulls Power changes direction downwards")
@OppositeBlock("BEPChangesUp")
@SortOrder(100)
...
public class BUPChangesDown extends ConditionBlock {
