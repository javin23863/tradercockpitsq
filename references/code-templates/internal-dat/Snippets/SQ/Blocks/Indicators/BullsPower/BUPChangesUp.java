...
@BuildingBlock(name="Bulls Power changes direction upwards", display="BullsPower(@Chart@#Period#)[#Shift#] changes direction upwards", returnType = ReturnTypes.Boolean)
