...
@BuildingBlock(name="Bulls Power is rising", display="BullsPower(@Chart@#Period#)[#Shift#] is rising", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Bulls Power is rising")
@OppositeBlock("BEPFalling")
@SortOrder(100)
@CategoryOrder(1200)
...
public class BUPRising extends ConditionBlock {
