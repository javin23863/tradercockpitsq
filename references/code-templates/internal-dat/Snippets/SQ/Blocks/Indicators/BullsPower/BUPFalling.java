...
@BuildingBlock(name="Bulls Power is falling", display="BullsPower(@Chart@#Period#)[#Shift#] is falling", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Bulls Power is falling")
@OppositeBlock("BEPRising")
@SortOrder(200)
...
public class BUPFalling extends ConditionBlock {
