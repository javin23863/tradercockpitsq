...
@BuildingBlock(name="(DVWAPD) Faster Anchored VWAP is below Slower Anchored VWAP", display="Faster AnchoredVWAP(@Chart@#FastSessionType#,#FastStdDevMult#)[#Shift#] is below Slower AnchoredVWAP(@Chart@#SlowSessionType#,#SlowStdDevMult#)[#Shift#]", returnType = ReturnTypes.Boolean)
