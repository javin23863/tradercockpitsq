...
@BuildingBlock(name="Bears Power is lower than Level", display="BearsPower(@Chart@#Period#)[#Shift#] < #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="BUPHigher", oscillator=true, middleValue=0, field="Level")
@SortOrder(400)
...
public class BEPLower extends ConditionBlock {
