...
@BuildingBlock(name="Bears Power is higher than Level", display="BearsPower(@Chart@#Period#)[#Shift#] > #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="BUPLower", oscillator=true, middleValue=0, field="Level")
@SortOrder(300)
...
public class BEPHigher extends ConditionBlock {
