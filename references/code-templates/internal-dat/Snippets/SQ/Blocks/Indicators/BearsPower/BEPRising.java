...
@BuildingBlock(name="Bears Power is rising", display="BearsPower(@Chart@#Period#)[#Shift#] is rising", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Bears Power is rising")
@OppositeBlock("BUPFalling")
@SortOrder(100)
@CategoryOrder(1200)
...
public class BEPRising extends ConditionBlock {
