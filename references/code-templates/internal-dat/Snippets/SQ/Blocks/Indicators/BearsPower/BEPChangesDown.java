...
@BuildingBlock(name="Bears Power changes direction downwards", display="BearsPower(@Chart@#Period#)[#Shift#] changes direction downwards", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Bears Power changes direction downwards")
@OppositeBlock("BUPChangesUp")
@SortOrder(100)
...
public class BEPChangesDown extends ConditionBlock {
