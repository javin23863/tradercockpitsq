...
@BuildingBlock(name="Bears Power crosses below Level", display="BearsPower(@Chart@#Period#)[#Shift#] crosses below #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="BUPCrossUp", oscillator=true, middleValue=0, field="Level")
@SortOrder(600)
...
public class BEPCrossDown extends ConditionBlock {
