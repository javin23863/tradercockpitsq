...
@BuildingBlock(name="(PRALX) SR Percent Rank is above Level for X Bars", display=" SR Percent Rank(@Chart@#Mode#,#Length#,#ATRPeriod#)[#Shift#] is above #Level# for #Bars# Bars", returnType = ReturnTypes.Boolean)
@Help("Is triggered if SRPercentRank is above Level for X Bars")
@OppositeBlock("SRPercRankAboveLevelXBars") /// this is correct 
