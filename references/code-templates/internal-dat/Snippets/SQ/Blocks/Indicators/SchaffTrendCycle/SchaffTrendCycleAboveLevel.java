...
@BuildingBlock(name="(STCAL) Schaff TrendCycle is above Level", display="Schaff Trend Cycle(@Chart@#StochPeriod#,#FastPeriod#,#SlowPeriod#)[#Shift#] is above #Level#", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Schaff Trend Cycle is above Level")
@OppositeBlock(value="SchaffTrendCycleBelowLevel",oscillator=true,middleValue=50,field="Level")
...
public class SchaffTrendCycleAboveLevel extends ConditionBlock {
	...
	@Parameter(defaultValue="80", isPeriod=false, minValue=10, maxValue=99.9, step=0.1)
	public double Level;
