...
@BuildingBlock(name="(STCCBL) Schaff TrendCycle crosses below Level", display="Schaff Trend Cycle(@Chart@#StochPeriod#,#FastPeriod#,#SlowPeriod#)[#Shift#] crosses below #Level#", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Schaff Trend Cycle crosses above Level")
@OppositeBlock(value="SchaffTrendCycleCrossesAboveLevel",oscillator=true,middleValue=50,field="Level")
...
public class SchaffTrendCycleCrossesBelowLevel extends ConditionBlock {
	...
	@Parameter(defaultValue="20", isPeriod=false, minValue=0.1, maxValue=99.9, step=0.1)
	public double Level;
