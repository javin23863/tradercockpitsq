...
@BuildingBlock(name="OSMA is rising", display="OSMA(@Chart@#FastEMA#, #SlowEMA#, #SignalPeriod#)[#Shift#] is rising", returnType = ReturnTypes.Boolean)
@Help("Is triggered if OSMA is rising")
@OppositeBlock("OSMAFalling")
@SortOrder(100)
@CategoryOrder(600)
...
public class OSMARising extends ConditionBlock {
