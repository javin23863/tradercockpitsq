...
@BuildingBlock(name="OSMA changes direction downwards", display="OSMA(@Chart@#FastEMA#, #SlowEMA#, #SignalPeriod#)[#Shift#] changes direction downwards", returnType = ReturnTypes.Boolean)
@Help("Is triggered if OSMA changes direction downwards")
@OppositeBlock("OSMAChangesUp")
@SortOrder(100)
...
public class OSMAChangesDown extends ConditionBlock {
