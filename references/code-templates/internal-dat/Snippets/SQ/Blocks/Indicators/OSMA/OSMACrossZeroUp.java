...
@BuildingBlock(name="OSMA crosses above 0", display="OSMA(@Chart@#FastEMA#, #SlowEMA#, #SignalPeriod#)[#Shift#] crosses above 0", returnType = ReturnTypes.Boolean)
@SortOrder(500)
@OppositeBlock("OSMACrossZeroDown")
...
public class OSMACrossZeroUp extends ConditionBlock {
