...
@BuildingBlock(name="ATR crosses above Level", display="ATR(@Chart@#Period#)[#Shift#] crosses above #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock("ATRCrossUp")
@SortOrder(500)
...
public class ATRCrossUp extends ConditionBlock {
