...
@BuildingBlock(name="ATR changes direction downwards", display="ATR(@Chart@#Period#)[#Shift#] changes direction downwards", returnType = ReturnTypes.Boolean)
@Help("Is triggered if ATR changes direction downwards")
@OppositeBlock("ATRChangesDown")
@SortOrder(100)
...
public class ATRChangesDown extends ConditionBlock {
