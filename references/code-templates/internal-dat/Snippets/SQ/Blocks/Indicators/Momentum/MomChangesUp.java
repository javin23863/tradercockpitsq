...
@BuildingBlock(name="Momentum changes direction upwards", display="Momentum(@Chart@#Period#)[#Shift#] changes direction upwards", returnType = ReturnTypes.Boolean)
@OppositeBlock("MomChangesDown")
...
public class MomChangesUp extends ConditionBlock {
