...
@BuildingBlock(name="Momentum crosses below Level", display="Momentum(@Chart@#Period#)[#Shift#] crosses below #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(600)
@OppositeBlock(value="MomCrossUp", oscillator=true, middleValue=100, field="Level")
