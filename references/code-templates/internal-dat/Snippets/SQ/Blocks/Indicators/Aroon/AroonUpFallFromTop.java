...
@BuildingBlock(name="Aroon Up falls from top", display="Aroon(@Chart@#Period#).Up[#Shift#] falls from top", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Aroon Up falls from top and Aroon Down is around middle of the range")
@OppositeBlock("AroonFallFromTop")
@ParameterSet(set="Period=14")
@ParameterSet(set="Period=20")
@ParameterSet(set="Period=30")
@ParameterSet(set="Period=40")
@ParameterSet(set="Period=50")
public class AroonUpFallFromTop extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		return (up1 == 100) && (up0 < 100) && (down0 < 70);
	}
