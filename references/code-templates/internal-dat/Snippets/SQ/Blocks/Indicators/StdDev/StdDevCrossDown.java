...
@BuildingBlock(name="StdDev crosses below Level", display="StdDev(@Chart@#Period#)[#Shift#] crosses below #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock("StdDevCrossDown")
...
public class StdDevCrossDown extends ConditionBlock {
	...
	@Parameter(defaultValue="0.01", minValue=0.0001, maxValue=3, step=0.01, builderMinValue=0.0001, builderMaxValue=3, builderStep=0.00025)
	public double Level;
	...
	public boolean OnBlockEvaluate() throws TradingException {
		StdDev indicator = Strategy.Indicators.StdDev(Input, Period);
