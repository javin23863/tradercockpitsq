...
@BuildingBlock(name="StdDev is lower than Level", display="StdDev(@Chart@#Period#)[#Shift#] < #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock("StdDevLower")
...
public class StdDevLower extends ConditionBlock {
