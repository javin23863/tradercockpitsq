 ...
 */
@BuildingBlock(name="(Ichimoku) Kumo breakout bullish", display="Ichimoku(@Chart@#TenkanPeriod#,#KijunPeriod#,#SenkouPeriod#)[#Shift#] Kumo breakout bullish", returnType = ReturnTypes.Boolean)
@OppositeBlock("IchimokuKumoBreakoutBearish")
@ParameterSet(set="TenkanPeriod=9,KijunPeriod=26,SenkouPeriod=52")
public class IchimokuKumoBreakoutBullish extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		boolean signal = (o < kumoTop) && c > kumoTop;
