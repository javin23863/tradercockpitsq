...
@BuildingBlock(name="Bar closes below LinReg", display="Bar closes below LinReg(@Chart@#Period#)[#Shift#]", returnType = ReturnTypes.Boolean, mainIndicator="LinearRegression")
@OppositeBlock("LinRegBarClosesAbove")
...
public class LinRegBarClosesBelow extends ConditionBlock {
