...
@BuildingBlock(name="Bar closes above LinReg", display="Bar closes above LinReg(@Chart@#Period#)[#Shift#]", returnType = ReturnTypes.Boolean, mainIndicator="LinearRegression")
@OppositeBlock("LinRegBarClosesBelow")
...
public class LinRegBarClosesAbove extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		double value1 = Strategy.Indicators.LinearRegression(Chart.getSeries(ComputedFrom), Period).Value.getRounded(Shift);
		return (Chart.Close(Shift) > value1);
	}
