...
@BuildingBlock(name="Bar opens above LinReg", display="Bar opens above LinReg(@Chart@#Period#)[#Shift#]", returnType = ReturnTypes.Boolean, mainIndicator="LinearRegression")
