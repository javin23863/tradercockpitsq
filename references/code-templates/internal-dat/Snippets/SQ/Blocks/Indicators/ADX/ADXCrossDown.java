...
@BuildingBlock(name="ADX crosses below Level", display="ADX(@Chart@#Period#)[#Shift#] crosses below #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="ADXCrossDown", middleValue=50, field="Level")
@SortOrder(600)
