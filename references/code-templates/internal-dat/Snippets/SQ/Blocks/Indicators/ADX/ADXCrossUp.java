...
@BuildingBlock(name="ADX crosses above Level", display="ADX(@Chart@#Period#)[#Shift#] crosses above #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="ADXCrossUp", middleValue=50, field="Level")
@SortOrder(500)
...
public class ADXCrossUp extends ConditionBlock {
	...
	@Parameter(defaultValue="0", minValue=1, maxValue=99, step=1)
	public double Level;
