...
@BuildingBlock(name="Awesome Oscillator is higher than Level", display="AwesomeOscillator(@Chart@)[#Shift#] > #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="AWOLower", oscillator=true, middleValue=0, field="Level")
