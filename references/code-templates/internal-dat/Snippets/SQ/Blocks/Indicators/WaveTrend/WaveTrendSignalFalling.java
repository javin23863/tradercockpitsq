...
@BuildingBlock(name="WaveTrend Signal line is falling", display="WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Signal[#Shift#] is falling", returnType = ReturnTypes.Boolean)
