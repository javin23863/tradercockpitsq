...
@BuildingBlock(name="WaveTrend Main line is falling", display="WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] is falling", returnType = ReturnTypes.Boolean)
