...
@BuildingBlock(name="WaveTrend Main line is higher than 0", display="WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] > 0", returnType = ReturnTypes.Boolean)
@SortOrder(1500)
@ForEngine("MT4,MT5,TS,MC")
@OppositeBlock("WaveTrendMainLowerZero")
...
public class WaveTrendMainHigherZero extends ConditionBlock {
