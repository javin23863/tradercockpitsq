...
@BuildingBlock(name="WaveTrend Main line changes direction downwards", display="WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] changes direction downwards", returnType = ReturnTypes.Boolean)
@Help("Is triggered if WaveTrend Main changes direction downwards")
@SortOrder(100)
@OppositeBlock("WaveTrendMainChangesUp")
...
public class WaveTrendMainChangesDown extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double value1 = indicator.WT1.getRounded(Shift + 2);
		double value2 = indicator.WT1.getRounded(Shift + 1);
		double value3 = indicator.WT1.getRounded(Shift);
