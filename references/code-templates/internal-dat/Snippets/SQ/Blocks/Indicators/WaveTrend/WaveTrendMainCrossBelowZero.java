...
@BuildingBlock(name="WaveTrend Main line crosses below 0", display="WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] crosses below 0", returnType = ReturnTypes.Boolean)
