...
@BuildingBlock(name="WaveTrend Main line is higher than Level", display="WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] > #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(1100)
@ForEngine("MT4,MT5,TS,MC")
@OppositeBlock(value="WaveTrendMainLower", oscillator=true, middleValue=0, field="Level")
