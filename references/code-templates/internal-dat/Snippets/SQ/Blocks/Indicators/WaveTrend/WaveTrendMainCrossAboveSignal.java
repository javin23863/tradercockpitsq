...
@BuildingBlock(name="WaveTrend Main line crosses above Signal", display="WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] crosses above WaveTrend.Signal", returnType = ReturnTypes.Boolean)
@SortOrder(500)
@ForEngine("MT4,MT5,TS,MC")
@OppositeBlock("WaveTrendMainCrossBelowSignal")
...
public class WaveTrendMainCrossAboveSignal extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double main1 = indicator.WT1.getRounded(Shift + 1);
		double main2 = indicator.WT1.getRounded(Shift);

		double signal1 = indicator.WT2.getRounded(Shift + 1);
		double signal2 = indicator.WT2.getRounded(Shift);
