...
@BuildingBlock(name="WaveTrend Main line is lower than Level", display="WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] < #Level#", returnType = ReturnTypes.Boolean)
@SortOrder(1200)
@ForEngine("MT4,MT5,TS,MC")
@OppositeBlock(value="WaveTrendMainHigher", oscillator=true, middleValue=0, field="Level")
...
public class WaveTrendMainLower extends ConditionBlock {
	...
	public boolean OnBlockEvaluate() throws TradingException {
		...
		double value1 = indicator.WT1.getRounded(Shift);
