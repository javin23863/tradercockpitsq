...
@BuildingBlock(name="WaveTrend Main line crosses above Level", display="WaveTrend(@Chart@#ChannelLength#,#AverageLength#).Main[#Shift#] crosses above #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="WaveTrendMainCrossBelow", oscillator=true, middleValue=0, field="Level")
@SortOrder(300)
...
public class WaveTrendMainCrossAbove extends ConditionBlock {
