...
@BuildingBlock(name="(CBK) Bar crosses below KAMA", display="Bar crosses below KAMA(@Chart@#ERPeriod#,#ShortPeriod#,#LongPeriod#)[#Shift#]", returnType = ReturnTypes.Boolean)
@Help("Is triggered if Bar closes below KAMA")
@MT5ExtendedTemplate
@OppositeBlock("BarClosesAboveKAMA")
public class BarClosesBelowKAMA extends ConditionBlock {
