...
@BuildingBlock(name="(FBSK)  Fast KAMA is below Slow KAMA", display="Fast KAMA(@Chart@#FastERPeriod#,#FastShortPeriod#,#FastLongPeriod#)[#Shift#] is below Slow KAMA(@Chart@#SlowERPeriod#,#SlowShortPeriod#,#SlowLongPeriod#)", returnType = ReturnTypes.Boolean)
