...
@BuildingBlock(name="Williams%R crosses above Level", display="Williams%R(@Chart@#Period#)[#Shift#] crosses above #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="WPRCrossDown", oscillator=true, middleValue=-50, field="Level")
@SortOrder(500)
...
public class WPRCrossUp extends ConditionBlock {
