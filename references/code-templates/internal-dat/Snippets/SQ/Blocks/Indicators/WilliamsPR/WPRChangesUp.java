...
@BuildingBlock(name="Williams%R changes direction upwards", display="Williams%R(@Chart@#Period#)[#Shift#] changes direction upwards", returnType = ReturnTypes.Boolean)
