...
@BuildingBlock(name="Williams%R is lower than Level", display="Williams%R(@Chart@#Period#)[#Shift#] < #Level#", returnType = ReturnTypes.Boolean)
@OppositeBlock(value="WPRHigher", oscillator=true, middleValue=-50, field="Level")
@SortOrder(400)
...
public class WPRLower extends ConditionBlock {
