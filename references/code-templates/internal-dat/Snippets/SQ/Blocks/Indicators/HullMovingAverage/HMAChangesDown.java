...
@BuildingBlock(name="HMA changes direction downwards", display="HMA(@Chart@#Period#)[#Shift#] changes direction downwards", returnType = ReturnTypes.Boolean)
@Help("Is triggered if HMA changes direction downwards")
@OppositeBlock("HMAChangesUP")
...
public class HMAChangesDown extends ConditionBlock {
