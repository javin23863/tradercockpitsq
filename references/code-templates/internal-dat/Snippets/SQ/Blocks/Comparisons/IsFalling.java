...
@BuildingBlock(name="Is falling", display="#Indicator# is falling", returnType = ReturnTypes.Boolean)
@OppositeBlock("IsRising")
@SortOrder(1000)
public class IsFalling extends IsOneComparisonBlockAbstract {

	@Parameter(name="Bars falling", defaultValue="2", minValue=2, builderMaxValue=50, maxValue=100, category="Properties")
