...
@BuildingBlock(name="(< X) Is lower for X bars", display="#IndicatorLeft# < #IndicatorRight# is true #Bars# bars" , returnType = ReturnTypes.Boolean)
@OppositeBlock("IsGreaterCount")
@SortOrder(100)
public class IsLowerCount extends CountComparisonBlockAbstract {
	...
	public boolean OnEvaluateComparison() throws TradingException {
		...
		for(int i=0; i<Bars; i++) {
			...
			double leftIndi = SQUtils.round(IndicatorLeft.evaluateBlock(index), 5); 
