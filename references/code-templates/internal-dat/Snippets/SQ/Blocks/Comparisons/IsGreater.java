...
@BuildingBlock(name="(>) Is greater", display="#Left# > #Right#", returnType = ReturnTypes.Boolean)
@OppositeBlock("IsLower")
@SortOrder(100)
public class IsGreater extends LeftRightComparisonBlockAbstract {
