...
@BuildingBlock(name="(MO) Monthly Open", returnType=ReturnTypes.Price, display="OpenM[@Chart@#Shift#]")
@SortOrder(500)
public class OpenM extends ValueBlock {
	...
	public double OnBlockEvaluate(int relativeShift) throws TradingException {
		...
		if(Engines.isTradestationEngine(Strategy.getEngine())) {
			...
			return Chart.OpenM(Shift + monthsOffset);
		}
		else {
			return Chart.OpenM(Shift + relativeShift);
		}
	}
