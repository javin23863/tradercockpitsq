...
@BuildingBlock(name="(SC) Session Close", returnType=ReturnTypes.Price, display="SessionClose(@Chart@#EndHours#:#EndMinutes#)[#Shift#]")
...
public class SessionClose extends ValueBlock {
	...
	protected void OnInit() throws BlockDefinitionException {
		sessionCalculator = new SessionOHLCCalculator(SessionOHLCCalculator.CLOSE, EndHours, EndMinutes, EndHours, EndMinutes, Shift, Chart);
	}
