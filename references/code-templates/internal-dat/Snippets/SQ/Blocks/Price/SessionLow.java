...
@BuildingBlock(name="(SL) Session Low", returnType=ReturnTypes.Price, display="SessionLow(@Chart@#StartHours#:#StartMinutes#-#EndHours#:#EndMinutes#)[#Shift#]")
@OppositeBlock("SessionHigh")
@SortOrder(800)
@ForEngine("*,-SP,-SA")
public class SessionLow extends ValueBlock {
	...
	protected void OnInit() throws BlockDefinitionException {
		sessionCalculator = new SessionOHLCCalculator(SessionOHLCCalculator.LOW, StartHours, StartMinutes, EndHours, EndMinutes, Shift, Chart);
	}
