...
public class WinLossCountByDayChart extends TradeAnalysisChart {

	public WinLossCountByDayChart() {
		this.name = L.tsq("Wins/Losses by day");
	}
	...
	public AbstractChart draw(OrdersList orders, byte plType, byte tradePeriod) {
		...
		for(int day=0; day<days.length; day++) {
			chart.addValue("winners", day+1, days[day][0]);
			chart.addValue("losers", day+1, days[day][1]);
		}
