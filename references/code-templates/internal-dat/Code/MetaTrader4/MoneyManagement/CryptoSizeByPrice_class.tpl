...
double sqMMCryptoSizeByPrice(string symbol, int orderType, double price, bool UseAccountBalance, double MaximumLots, int decimals, double multiplier, double sizeStep) {
