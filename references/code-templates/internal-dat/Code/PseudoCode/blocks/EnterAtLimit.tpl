    Open <@printParamOptions block "#Direction#" "1=Long,-1=Short" /> order at <@printPriceMethod block /> Limit;
<#if hasSetParam(block, "#BarsValid#") >
        Order valid for <@printParam block "#BarsValid#" /> bars;
</#if>                     
<#if getOptions("BacktestEngine") != "Stockpicker">
		...
		Replacing pending orders: <@printParamOptions block "#ReplaceExisting#" "true=allowed,false=disabled" />; 
