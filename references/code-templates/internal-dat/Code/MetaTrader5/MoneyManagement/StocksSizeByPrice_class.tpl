...
double sqMMStockSizeByPrice(string symbol, ENUM_ORDER_TYPE orderType, double price, bool UseAccountBalance, double MaximumLots, double multiplier, double sizeStep) {
   ...
   if(UseAccountBalance) {
	...
	LotSize = roundDown(LotSize, sizeStep, 0, symbol);
