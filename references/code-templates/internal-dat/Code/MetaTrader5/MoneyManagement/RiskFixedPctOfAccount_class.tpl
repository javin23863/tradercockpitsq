double sqMMRiskFixedAccountPct(string symbol, ENUM_ORDER_TYPE orderType, double price, double sl, double RiskInPercent, int decimals, int StopLossPips, double LotsIfNoMM, double MaximumLots, double multiplier, double sizeStep) {
   ...
   if(sl == 0){
      sl = openPrice - StopLossPips * SymbolInfoDouble(correctedSymbol, SYMBOL_POINT);
   }
